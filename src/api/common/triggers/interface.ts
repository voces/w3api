...
export const GetFilterDestructable = wrapRun( ( run ): destructable | null => run.filterDestructable );
export const GetEnumDestructable = wrapRun( ( run ): destructable | null => run.enumDestructable );
...
export const GetFilterPlayer = wrapRun( ( run ): player | null => run.filterPlayer );
export const GetEnumPlayer = wrapRun( ( run ): player | null => run.enumPlayer );
export const GetTriggeringTrigger = wrapRun( ( run ): trigger | null => run.triggeringTrigger );
export const GetTriggerEventId = wrapRun( ( run ): eventid | null => run.triggeringEventId );
export const GetTriggerEvalCount = ( whichTrigger: trigger ): number => whichTrigger.evaluations;
export const GetTriggerExecCount = ( whichTrigger: trigger ): number => whichTrigger.executions;
