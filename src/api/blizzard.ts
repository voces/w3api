...
export const Atan2BJ = (y: number, x: number): number =>
  Atan2(y, x) * bj_RADTODEG;

// ===========================================================================
export const AngleBetweenPoints = (locA: location, locB: location): number =>
  bj_RADTODEG *
  Atan2(
    GetLocationY(locB) - GetLocationY(locA),
    GetLocationX(locB) - GetLocationX(locA),
  );
...
// ===========================================================================
export const PolarProjectionBJ = (
  source: location,
  dist: number,
  angle: number,
): location => {
...
// ===========================================================================
export const OffsetLocation = (
  loc: location,
  dx: number,
  dy: number,
): location => Location(GetLocationX(loc) + dx, GetLocationY(loc) + dy);
...
// ===========================================================================
export const RectFromCenterSizeBJ = (
  center: location,
  width: number,
  height: number,
): rect => {
...
export const RectContainsUnit = (r: rect, whichUnit: unit): boolean =>
  RectContainsCoords(r, GetUnitX(whichUnit), GetUnitY(whichUnit));

// ===========================================================================
export const RectContainsItem = (whichItem: item, r: rect): boolean => {
  if (whichItem === null) return false;

  if (IsItemOwned(whichItem)) return false;
...
export const ConditionalTriggerExecute = (trig: trigger): void => {
  if (TriggerEvaluate(trig)) TriggerExecute(trig);
};

// ===========================================================================
// Runs the trigger's actions if the trigger's conditions evaluate to true.
//
export const TriggerExecuteBJ = (
  trig: trigger | null,
...
//
export const PostTriggerExecuteBJ = (
  trig: trigger,
  checkConditions: boolean,
): boolean => {
  if (checkConditions) if (!TriggerEvaluate(trig)) return false;
...
export const QueuedTriggerCheck = (): void => {
  ...
  while (true) {
    ...
    if (bj_queuedExecTriggers[i] === null) s = s + "null ";
    else s = s + "x ";
...
export const QueuedTriggerGetIndex = (trig: trigger): number => {
  ...
  while (true) {
    ...
    if (bj_queuedExecTriggers[index] === trig) return index;
...
export const QueuedTriggerRemoveByIndex = (trigIndex: number): boolean => {
  ...
  if (trigIndex >= bj_queuedExecTotal) return false;
...
export const QueuedTriggerAttemptExec = (): boolean => {
  while (true) {
    ...
    if (
      TriggerExecuteBJ(bj_queuedExecTriggers[0], bj_queuedExecUseConds[0])
    ) {
...
//
export const QueuedTriggerAddBJ = (
  trig: trigger,
  checkConditions: boolean,
): boolean => {
  // Make sure our queue isn't full.  If it is, return failure.

  if (bj_queuedExecTotal >= bj_MAX_QUEUED_TRIGGERS) return false;
  ...
  if (bj_queuedExecTotal === 1) QueuedTriggerAttemptExec();
...
// ===========================================================================
export const IntegerTertiaryOp = (
  flag: boolean,
  valueA: number,
  valueB: number,
): number => {
  if (flag) return valueA;
  else return valueB;
};
...
export const GetTimeOfDayScalePercentBJ = (): number =>
  GetTimeOfDayScale() * 100;

// ===========================================================================
export const PlaySound = (soundName: string): void => {
  const soundHandle = CreateSound(
    soundName,
    false,
    false,
    true,
...
export const CompareRectsBJ = (A: rect, B: rect): boolean =>
  GetRectMinX(A) === GetRectMinX(B) &&
  GetRectMinY(A) === GetRectMinY(B) &&
...
export const GetCurrentCameraSetup = (): camerasetup => {
  ...
  CameraSetupSetField(
    theCam,
    CAMERA_FIELD_ROLL,
    bj_RADTODEG * GetCameraField(CAMERA_FIELD_ROLL),
    duration,
  );
  CameraSetupSetField(
    theCam,
    CAMERA_FIELD_ROTATION,
    bj_RADTODEG * GetCameraField(CAMERA_FIELD_ROTATION),
    duration,
  );
  CameraSetupSetField(
    theCam,
...
// ===========================================================================
export const CameraSetupApplyForPlayer = (
  doPan: boolean,
...
// ===========================================================================
export const CameraSetupGetFieldSwap = (
  whichField: camerafield,
  whichSetup: camerasetup,
): number => CameraSetupGetField(whichSetup, whichField);

// ===========================================================================
export const SetCameraFieldForPlayer = (
  whichPlayer: player,
  whichField: camerafield,
  value: number,
  duration: number,
...
// ===========================================================================
export const SetCameraTargetControllerNoZForPlayer = (
  whichPlayer: player,
  whichUnit: unit,
  xoffset: number,
  yoffset: number,
...
// ===========================================================================
export const SetCameraPositionForPlayer = (
  whichPlayer: player,
  x: number,
  y: number,
): void => {
...
// ===========================================================================
export const SetCameraPositionLocForPlayer = (
  whichPlayer: player,
  loc: location,
): void => {
  if (GetLocalPlayer() === whichPlayer) {
...
// ===========================================================================
export const RotateCameraAroundLocBJ = (
  degrees: number,
  loc: location,
  whichPlayer: player,
  duration: number,
...
// ===========================================================================
export const PanCameraToForPlayer = (
  whichPlayer: player,
  x: number,
  y: number,
): void => {
...
// ===========================================================================
export const PanCameraToLocForPlayer = (
  whichPlayer: player,
  loc: location,
): void => {
  if (GetLocalPlayer() === whichPlayer) {
...
// ===========================================================================
export const PanCameraToTimedForPlayer = (
  whichPlayer: player,
  x: number,
  y: number,
  duration: number,
...
// ===========================================================================
export const PanCameraToTimedLocForPlayer = (
  whichPlayer: player,
  loc: location,
  duration: number,
): void => {
...
// ===========================================================================
export const PanCameraToTimedLocWithZForPlayer = (
  whichPlayer: player,
  loc: location,
  zOffset: number,
  duration: number,
...
// ===========================================================================
export const SetCinematicCameraForPlayer = (
  whichPlayer: player,
...
// ===========================================================================
export const ResetToGameCameraForPlayer = (
  whichPlayer: player,
  duration: number,
): void => {
  if (GetLocalPlayer() === whichPlayer) {
...
// ===========================================================================
export const CameraSetSourceNoiseForPlayer = (
  whichPlayer: player,
  magnitude: number,
  velocity: number,
): void => {
...
// ===========================================================================
export const CameraSetTargetNoiseForPlayer = (
  whichPlayer: player,
  magnitude: number,
  velocity: number,
): void => {
...
// ===========================================================================
export const CameraSetEQNoiseForPlayer = (
  whichPlayer: player,
  magnitude: number,
): void => {
  let richter = magnitude;

  if (richter > 5) richter = 5;

  if (richter < 2) richter = 2;

  if (GetLocalPlayer() === whichPlayer) {
    // Use only local code (no net traffic) within this block to avoid desyncs.
    CameraSetTargetNoiseEx(
      magnitude * 2,
      magnitude * Pow(10, richter),
      true,
    );
    CameraSetSourceNoiseEx(
      magnitude * 2,
...
// ===========================================================================
export const SetCameraBoundsToRectForPlayerBJ = (
  whichPlayer: player,
  r: rect,
): void => {
  if (GetLocalPlayer() === whichPlayer) {
...
// ===========================================================================
export const AdjustCameraBoundsBJ = (
  adjustMethod: number,
  dxWest: number,
  dxEast: number,
  dyNorth: number,
  ...
  if (adjustMethod === bj_CAMERABOUNDS_ADJUST_ADD) scale = 1;
  else if (adjustMethod === bj_CAMERABOUNDS_ADJUST_SUB) scale = -1;
...
// ===========================================================================
export const AdjustCameraBoundsForPlayerBJ = (
  adjustMethod: number,
  whichPlayer: player,
  dxWest: number,
  dxEast: number,
...
// ===========================================================================
export const SetCameraQuickPositionForPlayer = (
  whichPlayer: player,
  x: number,
  y: number,
): void => {
...
// ===========================================================================
export const SetCameraQuickPositionLocForPlayer = (
  whichPlayer: player,
  loc: location,
): void => {
  if (GetLocalPlayer() === whichPlayer) {
...
// ===========================================================================
export const SetCameraOrientControllerForPlayerBJ = (
  whichPlayer: player,
  whichUnit: unit,
  xoffset: number,
  yoffset: number,
...
// ===========================================================================
export const DisplayTimedTextToForce = (
  toForce: force,
  duration: number,
  message: string,
): void => {
...
//
export const SubStringBJ = (
  source: string,
  start: number,
  end: number,
): string => SubString(source, start - 1, end);
...
// ===========================================================================
export const TriggerRegisterTimerEventPeriodic = (
  trig: trigger,
  timeout: number,
): event => TriggerRegisterTimerEvent(trig, timeout, true);

// ===========================================================================
export const TriggerRegisterTimerEventSingle = (
  trig: trigger,
  timeout: number,
): event => TriggerRegisterTimerEvent(trig, timeout, false);

// ===========================================================================
export const TriggerRegisterTimerExpireEventBJ = (
  trig: trigger,
  t: timer,
): event => TriggerRegisterTimerExpireEvent(trig, t);

// ===========================================================================
export const TriggerRegisterPlayerUnitEventSimple = (
  trig: trigger,
  whichPlayer: player,
  whichEvent: playerunitevent,
): event => TriggerRegisterPlayerUnitEvent(trig, whichPlayer, whichEvent, null);

// ===========================================================================
export const TriggerRegisterAnyUnitEventBJ = (
  trig: trigger,
  whichEvent: playerunitevent,
): void => {
  let index: number;
...
// ===========================================================================
export const TriggerRegisterPlayerSelectionEventBJ = (
  trig: trigger,
  whichPlayer: player,
  selected: boolean,
): event => {
...
// ===========================================================================
export const TriggerRegisterPlayerKeyEventBJ = (
  trig: trigger,
  whichPlayer: player,
  keType: number,
  keKey: number,
...
// ===========================================================================
export const TriggerRegisterPlayerMouseEventBJ = (
  trig: trigger,
  whichPlayer: player,
  meType: number,
): event | null => {
...
// ===========================================================================
export const TriggerRegisterPlayerEventVictory = (
  trig: trigger,
  whichPlayer: player,
): event => TriggerRegisterPlayerEvent(trig, whichPlayer, EVENT_PLAYER_VICTORY);

// ===========================================================================
export const TriggerRegisterPlayerEventDefeat = (
  trig: trigger,
  whichPlayer: player,
): event => TriggerRegisterPlayerEvent(trig, whichPlayer, EVENT_PLAYER_DEFEAT);

// ===========================================================================
export const TriggerRegisterPlayerEventLeave = (
  trig: trigger,
  whichPlayer: player,
): event => TriggerRegisterPlayerEvent(trig, whichPlayer, EVENT_PLAYER_LEAVE);

// ===========================================================================
export const TriggerRegisterPlayerEventAllianceChanged = (
  trig: trigger,
  whichPlayer: player,
): event =>
  TriggerRegisterPlayerEvent(
...
// ===========================================================================
export const TriggerRegisterPlayerEventEndCinematic = (
  trig: trigger,
  whichPlayer: player,
): event =>
...
// ===========================================================================
export const TriggerRegisterGameStateEventTimeOfDay = (
  trig: trigger,
  opcode: limitop,
  limitval: number,
): event =>
...
// ===========================================================================
export const TriggerRegisterEnterRegionSimple = (
  trig: trigger,
  whichRegion: region,
): event => TriggerRegisterEnterRegion(trig, whichRegion, null);

// ===========================================================================
export const TriggerRegisterLeaveRegionSimple = (
  trig: trigger,
  whichRegion: region,
): event => TriggerRegisterLeaveRegion(trig, whichRegion, null);

// ===========================================================================
export const TriggerRegisterEnterRectSimple = (
  trig: trigger,
  r: rect,
): event => {
...
// ===========================================================================
export const TriggerRegisterLeaveRectSimple = (
  trig: trigger,
  r: rect,
): event => {
  const rectRegion = CreateRegion();
...
// ===========================================================================
export const TriggerRegisterDistanceBetweenUnits = (
  trig: trigger,
  whichUnit: unit,
  condition: boolexpr,
  range: number,
): event => TriggerRegisterUnitInRange(trig, whichUnit, range, condition);

// ===========================================================================
export const TriggerRegisterUnitInRangeSimple = (
  trig: trigger,
  range: number,
  whichUnit: unit,
): event => TriggerRegisterUnitInRange(trig, whichUnit, range, null);

// ===========================================================================
export const TriggerRegisterUnitLifeEvent = (
  trig: trigger,
  whichUnit: unit,
  opcode: limitop,
  limitval: number,
...
// ===========================================================================
export const TriggerRegisterUnitManaEvent = (
  trig: trigger,
  whichUnit: unit,
  opcode: limitop,
  limitval: number,
...
// ===========================================================================
export const TriggerRegisterDialogEventBJ = (
  trig: trigger,
  whichDialog: dialog,
): event => TriggerRegisterDialogEvent(trig, whichDialog);

// ===========================================================================
export const TriggerRegisterShowSkillEventBJ = (trig: trigger): event =>
  TriggerRegisterGameEvent(trig, EVENT_GAME_SHOW_SKILL);

// ===========================================================================
export const TriggerRegisterBuildSubmenuEventBJ = (trig: trigger): event =>
  TriggerRegisterGameEvent(trig, EVENT_GAME_BUILD_SUBMENU);
...
// ===========================================================================
export const TriggerRegisterDestDeathInRegionEvent = (
  trig: trigger,
  r: rect,
): void => {
...
// ===========================================================================
export const AddWeatherEffectSaveLast = (
  where: rect,
  effectID: number,
): weathereffect => {
...
// ===========================================================================
export const RemoveWeatherEffectBJ = (
...
// ===========================================================================
export const TerrainDeformationCraterBJ = (
  duration: number,
  permanent: boolean,
  where: location,
  radius: number,
  ...
  bj_lastCreatedTerrainDeformation = TerrainDeformCrater(
    GetLocationX(where),
    GetLocationY(where),
    radius,
    depth,
...
// ===========================================================================
export const TerrainDeformationRippleBJ = (
  duration: number,
  limitNeg: boolean,
  where: location,
  startRadius: number,
  ...
  wavePeriod: number,
  waveWidth: number,
): terraindeformation | null => {
  if (endRadius <= 0 || waveWidth <= 0 || wavePeriod <= 0) return null;

  const timeWave = (2 * duration) / wavePeriod;
  const spaceWave = (2 * endRadius) / waveWidth;
  const radiusRatio = startRadius / endRadius;

  bj_lastCreatedTerrainDeformation = TerrainDeformRipple(
    GetLocationX(where),
    GetLocationY(where),
    endRadius,
    depth,
...
// ===========================================================================
export const TerrainDeformationWaveBJ = (
  duration: number,
  source: location,
  target: location,
  radius: number,
  ...
  bj_lastCreatedTerrainDeformation = TerrainDeformWave(
    GetLocationX(source),
    GetLocationY(source),
    dirX,
    dirY,
...
// ===========================================================================
export const TerrainDeformationRandomBJ = (
  duration: number,
  where: location,
  radius: number,
  minDelta: number,
  ...
  bj_lastCreatedTerrainDeformation = TerrainDeformRandom(
    GetLocationX(where),
    GetLocationY(where),
    radius,
    minDelta,
...
// ===========================================================================
export const TerrainDeformationStopBJ = (
...
// ===========================================================================
export const AddLightningLoc = (
  codeName: string,
  where1: location,
  where2: location,
): lightning => {
  bj_lastCreatedLightning = AddLightningEx(
    codeName,
    true,
    GetLocationX(where1),
    GetLocationY(where1),
...
// ===========================================================================
export const SetLightningColorBJ = (
  whichBolt: lightning,
  r: number,
  g: number,
  b: number,
  a: number,
): boolean => SetLightningColor(whichBolt, r, g, b, a);
...
// ===========================================================================
export const GetAbilityEffectBJ = (
  abilcode: number,
  t: effecttype,
  index: number,
): string => GetAbilityEffectById(abilcode, t, index);

// ===========================================================================
export const GetAbilitySoundBJ = (abilcode: number, t: soundtype): string =>
  GetAbilitySoundById(abilcode, t);
...
export const GetTerrainTypeBJ = (where: location): number =>
  GetTerrainType(GetLocationX(where), GetLocationY(where));

// ===========================================================================
export const GetTerrainVarianceBJ = (where: location): number =>
  GetTerrainVariance(GetLocationX(where), GetLocationY(where));

// ===========================================================================
export const SetTerrainTypeBJ = (
  where: location,
  terrainType: number,
  variation: number,
  area: number,
...
export const IsTerrainPathableBJ = (where: location, t: pathingtype): boolean =>
  IsTerrainPathable(GetLocationX(where), GetLocationY(where), t);

// ===========================================================================
export const SetTerrainPathableBJ = (
  where: location,
  t: pathingtype,
  flag: boolean,
): void => {
...
// ===========================================================================
export const SetWaterBaseColorBJ = (
  red: number,
  green: number,
  blue: number,
  transparency: number,
...
// ===========================================================================
export const CreateFogModifierRectSimple = (
  whichPlayer: player,
  whichFogState: fogstate,
  r: rect,
  afterUnits: boolean,
): fogmodifier => {
  bj_lastCreatedFogModifier = CreateFogModifierRect(
    whichPlayer,
    whichFogState,
    r,
    true,
...
// ===========================================================================
export const CreateFogModifierRadiusLocSimple = (
  whichPlayer: player,
  whichFogState: fogstate,
  center: location,
  radius: number,
  ...
  bj_lastCreatedFogModifier = CreateFogModifierRadiusLoc(
    whichPlayer,
    whichFogState,
    center,
    radius,
...
//
export const CreateFogModifierRectBJ = (
  enabled: boolean,
  whichPlayer: player,
  whichFogState: fogstate,
  r: rect,
...
// can default to modifiers that are immediately enabled.
//
export const CreateFogModifierRadiusLocBJ = (
  enabled: boolean,
  whichPlayer: player,
  whichFogState: fogstate,
  center: location,
...
// ===========================================================================
export const SetTerrainFogExBJ = (
  style: number,
  zstart: number,
  zend: number,
  density: number,
...
// ===========================================================================
export const SetDoodadAnimationBJ = (
  animName: string,
  doodadID: number,
  radius: number,
  center: location,
...
// ===========================================================================
export const SetDoodadAnimationRectBJ = (
  animName: string,
  doodadID: number,
  r: rect,
): void => {
...
// ===========================================================================
export const AddUnitAnimationPropertiesBJ = (
  add: boolean,
...
export const CreateImageBJ = (
  ...
  bj_lastCreatedImage = CreateImage(
    file,
    size,
    size,
    size,
...
// ============================================================================
export const SetImagePositionBJ = (
  whichImage: image,
  where: location,
  zOffset: number,
): void => {
...
// ============================================================================
export const CreateUbersplatBJ = (
  where: location,
  name: string,
  red: number,
  green: number,
...
export const PlaySoundBJ = (soundHandle: sound): void => {
  ...
  if (soundHandle !== null) StartSound(soundHandle);
};
...
// ===========================================================================
export const SetSoundDistanceCutoffBJ = (
  soundHandle: sound,
  cutoff: number,
): void => {
...
// ===========================================================================
export const SetSoundPositionLocBJ = (
  soundHandle: sound,
  loc: location,
  z: number,
): void => {
...
// ===========================================================================
export const AttachSoundToUnitBJ = (
  soundHandle: sound,
  whichUnit: unit,
): void => {
...
// ===========================================================================
export const SetSoundConeAnglesBJ = (
  soundHandle: sound,
  inside: number,
  outside: number,
  ...
  SetSoundConeAngles(
    ...
    inside,
    outside,
    PercentToInt(outsideVolumePercent, 127),
  );
};
...
// ===========================================================================
export const PlaySoundAtPointBJ = (
  soundHandle: sound,
  volumePercent: number,
  loc: location,
  z: number,
...
// ===========================================================================
export const PlaySoundOnUnitBJ = (
  soundHandle: sound,
  volumePercent: number,
  whichUnit: unit,
): void => {
...
// ===========================================================================
export const PlaySoundFromOffsetBJ = (
  soundHandle: sound,
  volumePercent: number,
...
// ===========================================================================
export const PlayThematicMusicExBJ = (
  musicName: string,
  startingOffset: number,
): void => {
...
export const GetSoundDurationBJ = (soundHandle: sound): number => {
  ...
  else return I2R(GetSoundDuration(soundHandle)) * 0.001;
};

// ===========================================================================
export const GetSoundFileDurationBJ = (musicFileName: string): number =>
  I2R(GetSoundFileDuration(musicFileName)) * 0.001;
...
// ===========================================================================
export const VolumeGroupSetVolumeBJ = (
  vgroup: volumegroup,
  percent: number,
): void => {
...
export const SetCineModeVolumeGroupsBJ = (): void => {
  ...
  if (bj_gameStarted) SetCineModeVolumeGroupsImmediateBJ();
  else {
    TimerStart(
...
export const SetSpeechVolumeGroupsBJ = (): void => {
  ...
  if (bj_gameStarted) SetSpeechVolumeGroupsImmediateBJ();
  else {
    TimerStart(
      bj_volumeGroupsTimer,
      bj_GAME_STARTED_THRESHOLD,
...
export const VolumeGroupResetBJ = (): void => {
  ...
  if (bj_gameStarted) VolumeGroupResetImmediateBJ();
  else {
    TimerStart(
      bj_volumeGroupsTimer,
      bj_GAME_STARTED_THRESHOLD,
...
export const GetSoundIsPlayingBJ = (soundHandle: sound): boolean =>
  GetSoundIsLoading(soundHandle) || GetSoundIsPlaying(soundHandle);
...
// ===========================================================================
export const SetMapMusicIndexedBJ = (
  musicName: string,
  index: number,
): void => {
...
// ===========================================================================
export const SetStackedSoundBJ = (
  add: boolean,
  soundHandle: sound,
  r: rect,
): void => {
  ...
  if (add) RegisterStackedSound(soundHandle, true, width, height);
  else UnregisterStackedSound(soundHandle, true, width, height);
};

// ===========================================================================
export const StartSoundForPlayerBJ = (
  whichPlayer: player,
  soundHandle: sound,
): void => {
  if (whichPlayer === GetLocalPlayer()) StartSound(soundHandle);
};

// ===========================================================================
export const VolumeGroupSetVolumeForPlayerBJ = (
  whichPlayer: player,
  vgroup: volumegroup,
  scale: number,
): void => {
  if (GetLocalPlayer() === whichPlayer) VolumeGroupSetVolume(vgroup, scale);
};
...
export const SetAmbientDaySound = (inLabel: string): void => {
  ...
  if (bj_dayAmbientSound !== null) StopSound(bj_dayAmbientSound, true, true);
  ...
  if (ToD >= bj_TOD_DAWN && ToD < bj_TOD_DUSK) StartSound(bj_dayAmbientSound);
};
...
// ===========================================================================
export const AddSpecialEffectLocBJ = (
  where: location,
  modelName: string,
): effect => {
...
// ===========================================================================
export const AddSpecialEffectTargetUnitBJ = (
...
export const GetItemLoc = (whichItem: item): location =>
  Location(GetItemX(whichItem), GetItemY(whichItem));
...
export const SetHeroLevelBJ = (
  ...
  if (newLevel > oldLevel) SetHeroLevel(whichHero, newLevel, showEyeCandy);
...
// ===========================================================================
export const DecUnitAbilityLevelSwapped = (
  abilcode: number,
  whichUnit: unit,
): number => DecUnitAbilityLevel(whichUnit, abilcode);

// ===========================================================================
export const IncUnitAbilityLevelSwapped = (
  abilcode: number,
  whichUnit: unit,
): number => IncUnitAbilityLevel(whichUnit, abilcode);

// ===========================================================================
export const SetUnitAbilityLevelSwapped = (
  abilcode: number,
  whichUnit: unit,
  level: number,
): number => SetUnitAbilityLevel(whichUnit, abilcode, level);

// ===========================================================================
export const GetUnitAbilityLevelSwapped = (
  abilcode: number,
  whichUnit: unit,
): number => GetUnitAbilityLevel(whichUnit, abilcode);
...
export const UnitRemoveBuffBJ = (buffcode: number, whichUnit: unit): boolean =>
  UnitRemoveAbility(whichUnit, buffcode);

// ===========================================================================
export const UnitAddItemSwapped = (whichItem: item, whichHero: unit): boolean =>
  UnitAddItem(whichHero, whichItem);

// ===========================================================================
export const UnitAddItemByIdSwapped = (
  itemId: number,
  whichHero: unit,
): item => {
...
// ===========================================================================
export const UnitRemoveItemSwapped = (
  whichItem: item,
  whichHero: unit,
): void => {
...
//
export const UnitRemoveItemFromSlotSwapped = (
  itemSlot: number,
  whichHero: unit,
): item => {
...
// ===========================================================================
export const SetPlayerHandicapXPBJ = (
  whichPlayer: player,
...
export const GetPlayerHandicapXPBJ = (whichPlayer: player): number =>
  GetPlayerHandicapXP(whichPlayer) * 100;

// ===========================================================================
export const SetPlayerHandicapBJ = (
  whichPlayer: player,
  handicapPercent: number,
): void => {
...
export const GetPlayerHandicapBJ = (whichPlayer: player): number =>
  GetPlayerHandicap(whichPlayer) * 100;

// ===========================================================================
export const GetHeroStatBJ = (
  whichStat: number,
  whichHero: unit,
...
export const SetHeroStat = (
  ...
  if (whichStat === bj_HEROSTAT_STR) SetHeroStr(whichHero, value, true);
  else if (whichStat === bj_HEROSTAT_AGI) SetHeroAgi(whichHero, value, true);
  else if (whichStat === bj_HEROSTAT_INT) SetHeroInt(whichHero, value, true);
  else {
...
export const ModifyHeroStat = (
  ...
  if (modifyMethod === bj_MODIFYMETHOD_ADD) {
    SetHeroStat(
      whichHero,
      whichStat,
      GetHeroStatBJ(whichStat, whichHero, false) + value,
    );
...
// ===========================================================================
export const ModifyHeroSkillPoints = (
  whichHero: unit,
  modifyMethod: number,
  value: number,
): boolean => {
...
// ===========================================================================
export const UnitDropItemPointBJ = (
  whichUnit: unit,
  whichItem: item,
  x: number,
  y: number,
): boolean => UnitDropItemPoint(whichUnit, whichItem, x, y);

// ===========================================================================
export const UnitDropItemPointLoc = (
  whichUnit: unit,
  whichItem: item,
  loc: location,
): boolean =>
...
// ===========================================================================
export const UnitDropItemSlotBJ = (
  whichUnit: unit,
  whichItem: item,
  slot: number,
): boolean => UnitDropItemSlot(whichUnit, whichItem, slot - 1);

// ===========================================================================
export const UnitDropItemTargetBJ = (
  whichUnit: unit,
  whichItem: item,
  target: widget,
): boolean => UnitDropItemTarget(whichUnit, whichItem, target);

// ===========================================================================
// Two distinct trigger actions can't share the same function name, so this
// dummy function simply mimics the behavior of an existing call.
//
export const UnitUseItemDestructable = (
  whichUnit: unit,
  whichItem: item,
  target: widget,
): boolean => UnitUseItemTarget(whichUnit, whichItem, target);

// ===========================================================================
export const UnitUseItemPointLoc = (
  whichUnit: unit,
  whichItem: item,
  loc: location,
): boolean =>
...
export const UnitItemInSlotBJ = (whichUnit: unit, itemSlot: number): item =>
  UnitItemInSlot(whichUnit, itemSlot - 1);

// ===========================================================================
// Translates 0-based slot indices to 1-based slot indices.
//
export const GetInventoryIndexOfItemTypeBJ = (
  whichUnit: unit,
  itemId: number,
): number => {
  let index: number;
...
// ===========================================================================
export const GetItemOfTypeFromUnitBJ = (
  whichUnit: unit,
  itemId: number,
): item | null => {
...
export const UnitHasItemOfTypeBJ = (whichUnit: unit, itemId: number): boolean =>
  GetInventoryIndexOfItemTypeBJ(whichUnit, itemId) > 0;
...
export const UnitInventoryCount = (whichUnit: unit): number => {
  ...
  while (true) {
    if (UnitItemInSlot(whichUnit, index) !== null) count = count + 1;
...
// ===========================================================================
export const ChooseRandomItemExBJ = (
  level: number,
  whichType: itemtype,
): number => ChooseRandomItemEx(whichType, level);
...
//
export const RandomItemInRectBJ = (
  r: rect,
...
//
export const RandomItemInRectSimpleBJ = (r: rect): item | null =>
  RandomItemInRectBJ(r, null);

// ===========================================================================
export const CheckItemStatus = (whichItem: item, status: number): boolean => {
  if (status === bj_ITEM_STATUS_HIDDEN) return !IsItemVisible(whichItem);

  if (status === bj_ITEM_STATUS_OWNED) return IsItemOwned(whichItem);

  if (status === bj_ITEM_STATUS_INVULNERABLE) {
    return IsItemInvulnerable(whichItem);
  }

  if (status === bj_ITEM_STATUS_POWERUP) return IsItemPowerup(whichItem);

  if (status === bj_ITEM_STATUS_SELLABLE) return IsItemSellable(whichItem);

  if (status === bj_ITEM_STATUS_PAWNABLE) return IsItemPawnable(whichItem);
...
// ===========================================================================
export const CheckItemcodeStatus = (
  itemId: number,
  status: number,
): boolean => {
  if (status === bj_ITEMCODE_STATUS_POWERUP) return IsItemIdPowerup(itemId);

  if (status === bj_ITEMCODE_STATUS_SELLABLE) return IsItemIdSellable(itemId);

  if (status === bj_ITEMCODE_STATUS_PAWNABLE) return IsItemIdPawnable(itemId);
...
export const UnitId2StringBJ = (unitId: number): string => {
  ...
  if (unitString !== null) return unitString;
...
export const OrderId2StringBJ = (orderId: number): string => {
  ...
  if (orderString !== null) return orderString;
...
// ===========================================================================
export const CreateUnitAtLocSaveLast = (
  id: player,
  unitid: number,
  loc: location,
  face: number,
  ...
  if (unitid === FourCC("ugol")) {
    bj_lastCreatedUnit = CreateBlightedGoldmine(
      id,
      GetLocationX(loc),
      GetLocationY(loc),
      face,
...
// ===========================================================================
export const CreateNUnitsAtLoc = (
  count: number,
  unitId: number,
  whichPlayer: player,
  loc: location,
...
// ===========================================================================
export const CreateNUnitsAtLocFacingLocBJ = (
  count: number,
  unitId: number,
  whichPlayer: player,
  loc: location,
...
// ===========================================================================
export const CreateCorpseLocBJ = (
  unitid: number,
  whichPlayer: player,
  loc: location,
): unit => {
  bj_lastCreatedUnit = CreateCorpse(
    whichPlayer,
    unitid,
    GetLocationX(loc),
    GetLocationY(loc),
...
// ===========================================================================
export const CreatePermanentCorpseLocBJ = (
  style: number,
  unitid: number,
  whichPlayer: player,
  loc: location,
...
// ===========================================================================
export const GetUnitStateSwap = (
  whichState: unitstate,
  whichUnit: unit,
): number => GetUnitState(whichUnit, whichState);

// ===========================================================================
export const GetUnitStatePercent = (
  whichUnit: unit,
  whichState: unitstate,
  ...
  if (whichUnit === null || maxValue === 0) return 0;
...
export const GetUnitLifePercent = (whichUnit: unit): number =>
  GetUnitStatePercent(whichUnit, UNIT_STATE_LIFE, UNIT_STATE_MAX_LIFE);

// ===========================================================================
export const GetUnitManaPercent = (whichUnit: unit): number =>
  GetUnitStatePercent(whichUnit, UNIT_STATE_MANA, UNIT_STATE_MAX_MANA);
...
// ===========================================================================
export const SelectUnitForPlayerSingle = (
  whichUnit: unit,
  whichPlayer: player,
): void => {
  if (GetLocalPlayer() === whichPlayer) {
...
// ===========================================================================
export const SelectUnitAddForPlayer = (
  whichUnit: unit,
  whichPlayer: player,
): void => {
  if (GetLocalPlayer() === whichPlayer) {
...
// ===========================================================================
export const SelectUnitRemoveForPlayer = (
  whichUnit: unit,
  whichPlayer: player,
): void => {
  if (GetLocalPlayer() === whichPlayer) {
...
// ===========================================================================
export const SetUnitLifePercentBJ = (
  whichUnit: unit,
  percent: number,
): void => {
  SetUnitState(
...
// ===========================================================================
export const SetUnitManaPercentBJ = (
  whichUnit: unit,
  percent: number,
): void => {
  SetUnitState(
...
// ===========================================================================
export const IssueBuildOrderByIdLocBJ = (
  whichPeon: unit,
  unitId: number,
  loc: location,
): boolean => {
...
// ===========================================================================
export const IssueTrainOrderByIdBJ = (
  whichUnit: unit,
  unitId: number,
): boolean => IssueImmediateOrderById(whichUnit, unitId);

// ===========================================================================
export const GroupTrainOrderByIdBJ = (g: group, unitId: number): boolean =>
  GroupImmediateOrderById(g, unitId);

// ===========================================================================
export const IssueUpgradeOrderByIdBJ = (
  whichUnit: unit,
  techId: number,
...
// ===========================================================================
export const SetUnitTurnSpeedBJ = (
  whichUnit: unit,
  turnSpeed: number,
): void => {
...
// ===========================================================================
export const SetUnitPropWindowBJ = (
  whichUnit: unit,
  propWindow: number,
): void => {
...
export const GetUnitPropWindowBJ = (whichUnit: unit): number =>
  GetUnitPropWindow(whichUnit) * bj_RADTODEG;
...
// ===========================================================================
export const SetUnitBlendTimeBJ = (
  whichUnit: unit,
  blendTime: number,
): void => {
...
// ===========================================================================
export const SetUnitAcquireRangeBJ = (
  whichUnit: unit,
  acquireRange: number,
): void => {
...
export const EnableCreepSleepBJ = (enable: boolean): void => {
  SetPlayerState(
    ...
    PLAYER_STATE_NO_CREEP_SLEEP,
    IntegerTertiaryOp(enable, 0, 1),
  );

  // If we're disabling, attempt to wake any already-sleeping creeps.

  if (!enable) WakePlayerUnits(Player(PLAYER_NEUTRAL_AGGRESSIVE));
};

// ===========================================================================
export const UnitGenerateAlarms = (
  whichUnit: unit,
  generate: boolean,
): boolean => UnitIgnoreAlarm(whichUnit, !generate);
...
// ===========================================================================
export const UnitApplyTimedLifeBJ = (
  duration: number,
  buffId: number,
  whichUnit: unit,
): void => {
...
// ===========================================================================
export const UnitShareVisionBJ = (
  share: boolean,
  whichUnit: unit,
  whichPlayer: player,
): void => {
...
// ===========================================================================
export const UnitRemoveBuffsExBJ = (
  polarity: number,
  resist: number,
  whichUnit: unit,
  bTLife: boolean,
  ...
  const bPos = polarity === bj_BUFF_POLARITY_EITHER ||
    polarity === bj_BUFF_POLARITY_POSITIVE;
  const bNeg = polarity === bj_BUFF_POLARITY_EITHER ||
    polarity === bj_BUFF_POLARITY_NEGATIVE;
  const bMagic = resist === bj_BUFF_RESIST_BOTH ||
    resist === bj_BUFF_RESIST_MAGIC;
  const bPhys = resist === bj_BUFF_RESIST_BOTH ||
    resist === bj_BUFF_RESIST_PHYSICAL;
...
// ===========================================================================
export const UnitCountBuffsExBJ = (
  polarity: number,
  resist: number,
  whichUnit: unit,
  bTLife: boolean,
...
// ===========================================================================
export const UnitRemoveAbilityBJ = (
  abilityId: number,
  whichUnit: unit,
): boolean => UnitRemoveAbility(whichUnit, abilityId);
...
// ===========================================================================
export const UnitRemoveTypeBJ = (
  whichType: unittype,
  whichUnit: unit,
): boolean => UnitRemoveType(whichUnit, whichType);

// ===========================================================================
export const UnitAddTypeBJ = (whichType: unittype, whichUnit: unit): boolean =>
  UnitAddType(whichUnit, whichType);

// ===========================================================================
export const UnitMakeAbilityPermanentBJ = (
  permanent: boolean,
  abilityId: number,
  whichUnit: unit,
): boolean => UnitMakeAbilityPermanent(whichUnit, permanent, abilityId);
...
// ===========================================================================
export const IsUnitInTransportBJ = (
  whichUnit: unit,
  whichTransport: unit,
): boolean => IsUnitInTransport(whichUnit, whichTransport);
...
export const ReplaceUnitBJ = (
  ...
  if (newUnitId === FourCC("ugol")) {
    newUnit = CreateBlightedGoldmine(
      GetOwningPlayer(oldUnit),
      GetUnitX(oldUnit),
      GetUnitY(oldUnit),
  ...
  if (unitStateMethod === bj_UNIT_STATE_METHOD_RELATIVE) {
    ...
    if (GetUnitState(oldUnit, UNIT_STATE_MAX_LIFE) > 0) {
      oldRatio = GetUnitState(oldUnit, UNIT_STATE_LIFE) /
        GetUnitState(oldUnit, UNIT_STATE_MAX_LIFE);
      SetUnitState(
        newUnit,
        UNIT_STATE_LIFE,
        oldRatio * GetUnitState(newUnit, UNIT_STATE_MAX_LIFE),
      );
    }

    if (
      GetUnitState(oldUnit, UNIT_STATE_MAX_MANA) > 0 &&
      GetUnitState(newUnit, UNIT_STATE_MAX_MANA) > 0
    ) {
      oldRatio = GetUnitState(oldUnit, UNIT_STATE_MANA) /
        GetUnitState(oldUnit, UNIT_STATE_MAX_MANA);
      SetUnitState(
        newUnit,
        UNIT_STATE_MANA,
        oldRatio * GetUnitState(newUnit, UNIT_STATE_MAX_MANA),
      );
    }
    ...
    SetUnitState(
      newUnit,
      UNIT_STATE_LIFE,
      GetUnitState(oldUnit, UNIT_STATE_LIFE),
    );
    ...
    if (GetUnitState(newUnit, UNIT_STATE_MAX_MANA) > 0) {
      SetUnitState(
        newUnit,
        UNIT_STATE_MANA,
        GetUnitState(oldUnit, UNIT_STATE_MANA),
      );
    }
    ...
    SetUnitState(
      newUnit,
      UNIT_STATE_MANA,
      GetUnitState(newUnit, UNIT_STATE_MAX_MANA),
    );
  } else {
  ...
  if (
    IsUnitType(oldUnit, UNIT_TYPE_HERO) &&
    IsUnitType(newUnit, UNIT_TYPE_HERO)
  ) {
...
// ===========================================================================
export const SetUnitPositionLocFacingBJ = (
  whichUnit: unit,
  loc: location,
  facing: number,
): void => {
...
// ===========================================================================
export const SetUnitPositionLocFacingLocBJ = (
  whichUnit: unit,
  loc: location,
  lookAt: location,
): void => {
...
// ===========================================================================
export const RemoveItemFromStockBJ = (
  itemId: number,
  whichUnit: unit,
): void => {
...
// ===========================================================================
export const RemoveUnitFromStockBJ = (
  unitId: number,
  whichUnit: unit,
): void => {
...
// ===========================================================================
export const UnitDamagePointLoc = (
  whichUnit: unit,
  delay: number,
  radius: number,
  loc: location,
...
// ===========================================================================
export const UnitDamageTargetBJ = (
  whichUnit: unit,
  target: unit,
  amount: number,
  whichAttack: attacktype,
...
// ===========================================================================
export const CreateDestructableLoc = (
  objectid: number,
  loc: location,
  facing: number,
  scale: number,
  ...
  bj_lastCreatedDestructable = CreateDestructable(
    objectid,
    GetLocationX(loc),
    GetLocationY(loc),
    facing,
...
// ===========================================================================
export const CreateDeadDestructableLocBJ = (
  objectid: number,
  loc: location,
  facing: number,
  scale: number,
  ...
  bj_lastCreatedDestructable = CreateDeadDestructable(
    objectid,
    GetLocationX(loc),
    GetLocationY(loc),
    facing,
...
// ===========================================================================
export const SetDestructableInvulnerableBJ = (
  d: destructable,
  flag: boolean,
): void => {
...
export const GetDestructableLoc = (whichDestructable: destructable): location =>
  Location(
    GetDestructableX(whichDestructable),
    GetDestructableY(whichDestructable),
  );

// ===========================================================================
export const EnumDestructablesInRectAll = (
  r: rect,
  actionFunc: () => void,
): void => {
...
export const EnumDestructablesInCircleBJFilter = (): boolean => {
  ...
  const result = DistanceBetweenPoints(destLoc, bj_enumDestructableCenter) <=
...
//
export const RandomDestructableInRectBJ = (
  r: rect,
  filter: boolexpr | null,
): destructable | null => {
...
//
export const RandomDestructableInRectSimpleBJ = (
  r: rect,
): destructable | null => RandomDestructableInRectBJ(r, null);

// ===========================================================================
// Enumerates within a rect, with a filter to narrow the enumeration down
// objects within a circular area.
//
export const EnumDestructablesInCircleBJ = (
  radius: number,
  loc: location,
  actionFunc: () => void,
): void => {
...
// ===========================================================================
export const SetDestructableLifePercentBJ = (
  d: destructable,
  percent: number,
): void => {
...
// ===========================================================================
export const SetDestructableMaxLifeBJ = (
  d: destructable,
  max: number,
): void => {
...
export const ModifyGateBJ = (gateOperation: number, d: destructable): void => {
  if (gateOperation === bj_GATEOPERATION_CLOSE) {
    ...
    if (GetDestructableLife(d) > 0) KillDestructable(d);
...
//
export const ChangeElevatorHeight = (
  d: destructable,
  newHeight: number,
): void => {
  ...
  if (newHeight === 1) {
    ...
    else SetDestructableAnimation(d, "stand");
  } else if (newHeight === 2) {
    if (oldHeight === 1) {
      SetDestructableAnimation(d, "death");
    ...
    else SetDestructableAnimation(d, "stand second");
  } else if (newHeight === 3) {
    if (oldHeight === 1) {
    ...
    else SetDestructableAnimation(d, "stand third");
  } else {
...
//
export const ChangeElevatorWallBlocker = (
  x: number,
  y: number,
  facing: number,
  open: boolean,
  ...
  if (blocker === null) {
    blocker = CreateDeadDestructable(
  ...
  if (open) {
    ...
    if (GetDestructableLife(blocker) > 0) KillDestructable(blocker);
  } else {
    ...
    if (GetDestructableLife(blocker) <= 0) {
      DestructableRestoreLife(
        blocker,
        GetDestructableMaxLife(blocker),
        false,
      );
    }
...
// ===========================================================================
export const ChangeElevatorWalls = (
  open: boolean,
  walls: number,
  d: destructable,
): void => {
  ...
  if (
    walls === bj_ELEVATOR_WALL_TYPE_ALL ||
    walls === bj_ELEVATOR_WALL_TYPE_EAST
  ) {
  ...
  if (
    walls === bj_ELEVATOR_WALL_TYPE_ALL ||
    walls === bj_ELEVATOR_WALL_TYPE_NORTH
  ) {
  ...
  if (
    walls === bj_ELEVATOR_WALL_TYPE_ALL ||
    walls === bj_ELEVATOR_WALL_TYPE_SOUTH
  ) {
    if (!NearbyElevatorExists(x, y - distToNeighbor)) {
      ChangeElevatorWallBlocker(x, y - distToBlocker, 90, open);
    }
  ...
  if (
    walls === bj_ELEVATOR_WALL_TYPE_ALL ||
    walls === bj_ELEVATOR_WALL_TYPE_WEST
  ) {
    if (!NearbyElevatorExists(x - distToNeighbor, y)) {
      ChangeElevatorWallBlocker(x - distToBlocker, y, 0, open);
    }
...
// ===========================================================================
export const WaygateSetDestinationLocBJ = (
  waygate: unit,
  loc: location,
): void => {
...
export const WaygateGetDestinationLocBJ = (waygate: unit): location =>
  Location(WaygateGetDestinationX(waygate), WaygateGetDestinationY(waygate));
...
// ===========================================================================
export const GroupAddUnitSimple = (
  whichUnit: unit,
  whichGroup: group,
): void => {
...
// ===========================================================================
export const GroupRemoveUnitSimple = (
  whichUnit: unit,
  whichGroup: group,
): void => {
...
// ===========================================================================
export const ForceAddPlayerSimple = (
  whichPlayer: player,
  whichForce: force,
): void => {
...
// ===========================================================================
export const ForceRemovePlayerSimple = (
  whichPlayer: player,
  whichForce: force,
): void => {
...
// ===========================================================================
export const EnumUnitsSelected = (
  whichPlayer: player,
  enumFilter: boolexpr,
  enumAction: () => void,
): void => {
...
// ===========================================================================
export const GetUnitsInRectMatching = (
  r: rect,
  filter: boolexpr | null,
): group => {
  const g = CreateGroup();
...
// ===========================================================================
export const GetUnitsInRangeOfLocMatching = (
  radius: number,
...
// ===========================================================================
export const GetUnitsInRangeOfLocAll = (
  radius: number,
  whichLocation: location,
): group => GetUnitsInRangeOfLocMatching(radius, whichLocation, null);
...
// ===========================================================================
export const GetUnitsOfPlayerMatching = (
  whichPlayer: player,
  filter: boolexpr | null,
): group => {
  const g = CreateGroup();
...
export const GetUnitsOfPlayerAll = (whichPlayer: player): group =>
  GetUnitsOfPlayerMatching(whichPlayer, null);
...
export const GetRandomSubGroupEnum = (): void => {
  if (bj_randomSubGroupWant > 0) {
    if (
      bj_randomSubGroupWant >= bj_randomSubGroupTotal ||
...
export const GetRandomSubGroup = (count: number, sourceGroup: group): group => {
  ...
  if (bj_randomSubGroupWant <= 0 || bj_randomSubGroupTotal <= 0) return g;

  bj_randomSubGroupChance = I2R(bj_randomSubGroupWant) /
    I2R(bj_randomSubGroupTotal);
...
// ===========================================================================
export const CountLivingPlayerUnitsOfTypeId = (
  unitId: number,
  whichPlayer: player,
): number => {
  const g = CreateGroup();
...
// ===========================================================================
export const SetUnitTimeScalePercent = (
  whichUnit: unit,
  percentScale: number,
): void => {
...
// ===========================================================================
export const SetUnitScalePercent = (
  whichUnit: unit,
...
//
export const SetUnitVertexColorBJ = (
  whichUnit: unit,
  red: number,
  green: number,
  blue: number,
...
// ===========================================================================
export const UnitAddIndicatorBJ = (
  whichUnit: unit,
  red: number,
  green: number,
  blue: number,
...
// ===========================================================================
export const DestructableAddIndicatorBJ = (
...
// ===========================================================================
export const ItemAddIndicatorBJ = (
  whichItem: item,
  red: number,
  green: number,
  blue: number,
...
//
export const SetUnitFacingToFaceLocTimed = (
  whichUnit: unit,
  target: location,
  duration: number,
): void => {
  ...
  SetUnitFacingTimed(
    whichUnit,
    AngleBetweenPoints(unitLoc, target),
    duration,
  );
...
//
export const SetUnitFacingToFaceUnitTimed = (
  whichUnit: unit,
  target: unit,
  duration: number,
): void => {
...
// ===========================================================================
export const QueueUnitAnimationBJ = (
  whichUnit: unit,
...
// ===========================================================================
export const SetDestructableAnimationBJ = (
  d: destructable,
  whichAnimation: string,
): void => {
...
// ===========================================================================
export const QueueDestructableAnimationBJ = (
  d: destructable,
  whichAnimation: string,
): void => {
...
// ===========================================================================
export const SetDestAnimationSpeedPercent = (
  d: destructable,
  percentScale: number,
): void => {
...
// ===========================================================================
export const DialogSetMessageBJ = (
  whichDialog: dialog,
  message: string,
): void => {
...
// ===========================================================================
export const DialogAddButtonBJ = (
  whichDialog: dialog,
  buttonText: string,
): button => {
...
// ===========================================================================
export const DialogAddButtonWithHotkeyBJ = (
  whichDialog: dialog,
  buttonText: string,
  hotkey: number,
): button => {
...
// ===========================================================================
export const SetPlayerAllianceBJ = (
  sourcePlayer: player,
...
//
export const SetPlayerAllianceStateAllyBJ = (
  sourcePlayer: player,
  otherPlayer: player,
  flag: boolean,
): void => {
...
//
export const SetPlayerAllianceStateVisionBJ = (
  sourcePlayer: player,
  otherPlayer: player,
  flag: boolean,
): void => {
...
//
export const SetPlayerAllianceStateControlBJ = (
  sourcePlayer: player,
  otherPlayer: player,
  flag: boolean,
): void => {
...
//
export const SetPlayerAllianceStateFullControlBJ = (
  sourcePlayer: player,
  otherPlayer: player,
  flag: boolean,
): void => {
...
// ===========================================================================
export const SetPlayerAllianceStateBJ = (
  sourcePlayer: player,
  otherPlayer: player,
...
//
export const SetForceAllianceStateBJ = (
  sourceForce: force,
  targetForce: force,
  allianceState: number,
): void => {
  ...
  while (true) {
    if (
      sourceForce === bj_FORCE_ALL_PLAYERS ||
      IsPlayerInForce(Player(sourceIndex), sourceForce)
    ) {
      targetIndex = 0;

      while (true) {
        if (
          targetForce === bj_FORCE_ALL_PLAYERS ||
          IsPlayerInForce(Player(targetIndex), targetForce)
        ) {
...
//
export const PlayersAreCoAllied = (
  playerA: player,
  playerB: player,
): boolean => {
  ...
  if (GetPlayerAlliance(playerA, playerB, ALLIANCE_PASSIVE)) {
    if (GetPlayerAlliance(playerB, playerA, ALLIANCE_PASSIVE)) return true;
  }
...
export const ShareEverythingWithTeamAI = (whichPlayer: player): void => {
  ...
  while (true) {
    ...
    if (
      PlayersAreCoAllied(whichPlayer, indexPlayer) &&
      whichPlayer !== indexPlayer
    ) {
      if (GetPlayerController(indexPlayer) === MAP_CONTROL_COMPUTER) {
        SetPlayerAlliance(
          whichPlayer,
...
export const AllowVictoryDefeat = (gameResult: playergameresult): boolean => {
  if (gameResult === PLAYER_GAME_RESULT_VICTORY) return !IsNoVictoryCheat();

  if (gameResult === PLAYER_GAME_RESULT_DEFEAT) return !IsNoDefeatCheat();
...
// ===========================================================================
export const MeleeVictoryDialogBJ = (
  whichPlayer: player,
  leftGame: boolean,
): void => {
  let t = CreateTrigger();
  ...
  if (leftGame) formatString = GetLocalizedString("PLAYER_LEFT_GAME");
  else formatString = GetLocalizedString("PLAYER_VICTORIOUS");
  ...
  DialogAddButton(
    d,
    GetLocalizedString("GAMEOVER_CONTINUE_GAME"),
    GetLocalizedHotkey("GAMEOVER_CONTINUE_GAME"),
  );
  ...
  TriggerRegisterDialogButtonEvent(
    ...
    DialogAddQuitButton(
      d,
      true,
      GetLocalizedString("GAMEOVER_QUIT_GAME"),
      GetLocalizedHotkey("GAMEOVER_QUIT_GAME"),
    ),
  );
...
// ===========================================================================
export const MeleeDefeatDialogBJ = (
  whichPlayer: player,
  leftGame: boolean,
): void => {
  let t = CreateTrigger();
  ...
  if (leftGame) formatString = GetLocalizedString("PLAYER_LEFT_GAME");
  else formatString = GetLocalizedString("PLAYER_DEFEATED");
...
export const GameOverDialogBJ = (
  ...
  TriggerRegisterDialogButtonEvent(
    ...
    DialogAddQuitButton(
      d,
      true,
      GetLocalizedString("GAMEOVER_OK"),
      GetLocalizedHotkey("GAMEOVER_OK"),
    ),
  );
...
// ===========================================================================
export const RemovePlayerPreserveUnitsBJ = (
  whichPlayer: player,
  ...
  if (AllowVictoryDefeat(gameResult)) {
    ...
    } else GameOverDialogBJ(whichPlayer, leftGame);
  }
};
...
export const CustomVictoryDialogBJ = (whichPlayer: player): void => {
  ...
  TriggerRegisterDialogButtonEvent(
    ...
    DialogAddButton(
      d,
      GetLocalizedString("GAMEOVER_CONTINUE"),
  ...
  TriggerRegisterDialogButtonEvent(
    ...
    DialogAddButton(
      d,
      GetLocalizedString("GAMEOVER_QUIT_MISSION"),
  ...
  if (GetLocalPlayer() === whichPlayer) {
    ...
    if (bj_isSinglePlayer) PauseGame(true);
  ...
  if (AllowVictoryDefeat(PLAYER_GAME_RESULT_VICTORY)) {
    ...
    if (!bj_isSinglePlayer) {
      DisplayTimedTextFromPlayer(
        ...
        0,
        60,
        GetLocalizedString("PLAYER_VICTORIOUS"),
      );
    }
    ...
    if (GetPlayerController(whichPlayer) === MAP_CONTROL_USER) {
      ...
      if (showDialog) CustomVictoryDialogBJ(whichPlayer);
      else CustomVictorySkipBJ(whichPlayer);
    }
  }
};
...
export const CustomDefeatQuitBJ = (): void => {
  if (bj_isSinglePlayer) PauseGame(false);
...
// ===========================================================================
export const CustomDefeatDialogBJ = (
  whichPlayer: player,
  message: string,
): void => {
  let t = CreateTrigger();
  ...
  if (bj_isSinglePlayer) {
    ...
    TriggerRegisterDialogButtonEvent(
      ...
      DialogAddButton(
        d,
        GetLocalizedString("GAMEOVER_RESTART"),
        GetLocalizedHotkey("GAMEOVER_RESTART"),
      ),
    );
    ...
    TriggerRegisterDialogButtonEvent(
      ...
      DialogAddButton(
        d,
        GetLocalizedString("GAMEOVER_LOAD"),
        GetLocalizedHotkey("GAMEOVER_LOAD"),
      ),
    );
  ...
  if (AllowVictoryDefeat(PLAYER_GAME_RESULT_DEFEAT)) {
    ...
    if (!bj_isSinglePlayer) {
      DisplayTimedTextFromPlayer(
        ...
        0,
        60,
        GetLocalizedString("PLAYER_DEFEATED"),
      );
    }
...
// ===========================================================================
export const SetPlayerOnScoreScreenBJ = (
  flag: boolean,
  whichPlayer: player,
): void => {
...
// ===========================================================================
export const CreateQuestBJ = (
  questType: number,
  title: string,
  description: string,
  iconPath: string,
): quest => {
  const required = questType === bj_QUESTTYPE_REQ_DISCOVERED ||
    questType === bj_QUESTTYPE_REQ_UNDISCOVERED;
  const discovered = questType === bj_QUESTTYPE_REQ_DISCOVERED ||
...
// ===========================================================================
export const QuestSetEnabledBJ = (
  enabled: boolean,
  whichQuest: quest,
): void => {
...
// ===========================================================================
export const QuestSetDescriptionBJ = (
  whichQuest: quest,
  description: string,
): void => {
...
// ===========================================================================
export const QuestSetCompletedBJ = (
  whichQuest: quest,
  completed: boolean,
): void => {
...
// ===========================================================================
export const QuestSetDiscoveredBJ = (
  whichQuest: quest,
  discovered: boolean,
): void => {
...
// ===========================================================================
export const CreateQuestItemBJ = (
  whichQuest: quest,
  description: string,
): questitem => {
...
// ===========================================================================
export const QuestItemSetDescriptionBJ = (
...
// ===========================================================================
export const QuestItemSetCompletedBJ = (
  whichQuestItem: questitem,
  completed: boolean,
): void => {
...
// ===========================================================================
export const CreateDefeatConditionBJ = (
  description: string,
): defeatcondition => {
...
// ===========================================================================
export const DestroyDefeatConditionBJ = (
...
// ===========================================================================
export const DefeatConditionSetDescriptionBJ = (
  whichCondition: defeatcondition,
  description: string,
): void => {
...
export const PauseTimerBJ = (pause: boolean, whichTimer: timer): void => {
  if (pause) PauseTimer(whichTimer);
  else ResumeTimer(whichTimer);
};
...
// ===========================================================================
export const TimerDialogSetTitleColorBJ = (
  td: timerdialog,
  red: number,
  green: number,
  blue: number,
...
// ===========================================================================
export const TimerDialogSetTimeColorBJ = (
  td: timerdialog,
  red: number,
  green: number,
  blue: number,
...
// ===========================================================================
export const TimerDialogSetSpeedBJ = (
  td: timerdialog,
...
// ===========================================================================
export const TimerDialogDisplayForPlayerBJ = (
  show: boolean,
  td: timerdialog,
  whichPlayer: player,
): void => {
...
export const LeaderboardResizeBJ = (lb: leaderboard): void => {
  ...
  if (LeaderboardGetLabelText(lb) === "") size = size - 1;

  LeaderboardSetSizeByItemCount(lb, size);
};

// ===========================================================================
export const LeaderboardSetPlayerItemValueBJ = (
  whichPlayer: player,
  lb: leaderboard,
  val: number,
): void => {
...
// ===========================================================================
export const LeaderboardSetPlayerItemLabelBJ = (
  whichPlayer: player,
  lb: leaderboard,
  val: string,
): void => {
...
// ===========================================================================
export const LeaderboardSetPlayerItemStyleBJ = (
  whichPlayer: player,
  lb: leaderboard,
  showLabel: boolean,
  showValue: boolean,
...
// ===========================================================================
export const LeaderboardSetPlayerItemLabelColorBJ = (
  whichPlayer: player,
  lb: leaderboard,
  red: number,
  green: number,
...
// ===========================================================================
export const LeaderboardSetPlayerItemValueColorBJ = (
  whichPlayer: player,
  lb: leaderboard,
  red: number,
  green: number,
...
// ===========================================================================
export const LeaderboardSetLabelColorBJ = (
  lb: leaderboard,
  red: number,
  green: number,
  blue: number,
...
// ===========================================================================
export const LeaderboardSetValueColorBJ = (
  lb: leaderboard,
  red: number,
  green: number,
  blue: number,
...
// ===========================================================================
export const LeaderboardSetStyleBJ = (
  lb: leaderboard,
  showLabel: boolean,
  showNames: boolean,
  showValues: boolean,
...
// ===========================================================================
export const LeaderboardHasPlayerItemBJ = (
  lb: leaderboard,
  whichPlayer: player,
): boolean => LeaderboardHasPlayerItem(lb, whichPlayer);

// ===========================================================================
export const ForceSetLeaderboardBJ = (
  lb: leaderboard,
  toForce: force,
): void => {
  let index: number;
...
// ===========================================================================
export const CreateLeaderboardBJ = (
  toForce: force,
  label: string,
): leaderboard => {
...
// ===========================================================================
export const LeaderboardAddItemBJ = (
  whichPlayer: player,
  lb: leaderboard,
  label: string,
  value: number,
...
// ===========================================================================
export const LeaderboardRemovePlayerItemBJ = (
  whichPlayer: player,
  lb: leaderboard,
): void => {
  LeaderboardRemovePlayerItem(lb, whichPlayer);
...
// ===========================================================================
export const LeaderboardSortItemsBJ = (
  lb: leaderboard,
  sortType: number,
  ascending: boolean,
): void => {
...
// ===========================================================================
export const LeaderboardSortItemsByPlayerBJ = (
  lb: leaderboard,
  ascending: boolean,
): void => {
  LeaderboardSortItemsByPlayer(lb, ascending);
...
// ===========================================================================
export const LeaderboardSortItemsByLabelBJ = (
  lb: leaderboard,
  ascending: boolean,
): void => {
  LeaderboardSortItemsByLabel(lb, ascending);
...
// ===========================================================================
export const LeaderboardGetPlayerIndexBJ = (
  whichPlayer: player,
  lb: leaderboard,
): number => LeaderboardGetPlayerIndex(lb, whichPlayer) + 1;
...
//
export const LeaderboardGetIndexedPlayerBJ = (
  position: number,
  lb: leaderboard,
): player => {
  let index: number;
...
export const PlayerGetLeaderboardBJ = (whichPlayer: player): leaderboard =>
  PlayerGetLeaderboard(whichPlayer);
...
// ===========================================================================
export const CreateMultiboardBJ = (
  cols: number,
  rows: number,
  title: string,
): multiboard => {
...
// ===========================================================================
export const MultiboardMinimizeBJ = (
  minimize: boolean,
  mb: multiboard,
): void => {
...
// ===========================================================================
export const MultiboardSetTitleTextColorBJ = (
  mb: multiboard,
  red: number,
  green: number,
  blue: number,
...
// ===========================================================================
export const MultiboardSetItemStyleBJ = (
  mb: multiboard,
  col: number,
  row: number,
  showValue: boolean,
...
// ===========================================================================
export const MultiboardSetItemValueBJ = (
  mb: multiboard,
  col: number,
  row: number,
  val: string,
...
// ===========================================================================
export const MultiboardSetItemColorBJ = (
  mb: multiboard,
  col: number,
  row: number,
  red: number,
...
// ===========================================================================
export const MultiboardSetItemWidthBJ = (
  mb: multiboard,
  col: number,
  row: number,
  width: number,
...
// ===========================================================================
export const MultiboardSetItemIconBJ = (
  mb: multiboard,
  col: number,
  row: number,
  iconFileName: string,
...
// ===========================================================================
export const SetTextTagColorBJ = (
  tt: texttag,
  red: number,
  green: number,
  blue: number,
...
// ===========================================================================
export const SetTextTagVelocityBJ = (
  tt: texttag,
  speed: number,
  angle: number,
): void => {
...
// ===========================================================================
export const SetTextTagPosUnitBJ = (
  tt: texttag,
  whichUnit: unit,
  zOffset: number,
): void => {
...
// ===========================================================================
export const CreateTextTagLocBJ = (
  s: string,
  loc: location,
  zOffset: number,
  size: number,
...
// ===========================================================================
export const CreateTextTagUnitBJ = (
  s: string,
  whichUnit: unit,
  zOffset: number,
  size: number,
...
// ===========================================================================
export const ShowTextTagForceBJ = (
  show: boolean,
  tt: texttag,
  whichForce: force,
): void => {
...
// ===========================================================================
export const ShowInterfaceForceOn = (
  whichForce: force,
  fadeDuration: number,
): void => {
  if (IsPlayerInForce(GetLocalPlayer(), whichForce)) {
...
// ===========================================================================
export const ShowInterfaceForceOff = (
  whichForce: force,
  fadeDuration: number,
): void => {
  if (IsPlayerInForce(GetLocalPlayer(), whichForce)) {
...
// ===========================================================================
export const PingMinimapForForce = (
  whichForce: force,
  x: number,
  y: number,
  duration: number,
...
// ===========================================================================
export const PingMinimapLocForForce = (
  whichForce: force,
  loc: location,
  duration: number,
): void => {
...
// ===========================================================================
export const PingMinimapForPlayer = (
  whichPlayer: player,
  x: number,
  y: number,
  duration: number,
...
// ===========================================================================
export const PingMinimapLocForPlayer = (
  whichPlayer: player,
  loc: location,
  duration: number,
): void => {
...
// ===========================================================================
export const PingMinimapForForceEx = (
  whichForce: force,
  x: number,
  y: number,
  duration: number,
  ...
  if (IsPlayerInForce(GetLocalPlayer(), whichForce)) {
    ...
    if (red255 === 255 && green255 === 0 && blue255 === 0) red255 = 254;
...
// ===========================================================================
export const PingMinimapLocForForceEx = (
  whichForce: force,
  loc: location,
  duration: number,
  style: number,
...
// ===========================================================================
export const SetCinematicSceneBJ = (
  soundHandle: sound,
...
// ===========================================================================
export const GetTransmissionDuration = (
  soundHandle: sound,
  timeType: number,
  timeVal: number,
): number => {
  ...
  } else if (timeType === bj_TIMETYPE_SET) duration = timeVal;
  else if (timeType === bj_TIMETYPE_SUB) {
    duration = GetSoundDurationBJ(soundHandle) - timeVal;
  } // Unrecognized timeType - ignore timeVal.
  else duration = GetSoundDurationBJ(soundHandle);
...
// ===========================================================================
export const WaitTransmissionDuration = (
  soundHandle: sound,
  timeType: number,
  timeVal: number,
): void => {
...
// ===========================================================================
export const DoTransmissionBasicsXYBJ = (
  unitId: number,
  color: playercolor,
  x: number,
  y: number,
  ...
  SetCinematicSceneBJ(
    ...
    unitName,
    message,
    duration + bj_TRANSMISSION_PORT_HANGTIME,
    duration,
  );

  if (unitId !== 0) PingMinimap(x, y, bj_TRANSMISSION_PING_TIME);
...
//   - Ping the minimap
//
export const TransmissionFromUnitWithNameBJ = (
  toForce: force,
  whichUnit: unit,
  unitName: string,
  soundHandle: sound,
  ...
  bj_lastTransmissionDuration = GetTransmissionDuration(
    soundHandle,
    timeType,
    timeVal,
  );
...
//
export const TransmissionFromUnitTypeWithNameBJ = (
  toForce: force,
  fromPlayer: player,
  unitId: number,
  unitName: string,
...
//
export const CinematicModeExBJ = (
  cineMode: boolean,
  forForce: force,
  ...
  if (!bj_gameStarted) interfaceFadeTime = 0;
...
// ===========================================================================
export const CinematicFadeCommonBJ = (
  red: number,
  green: number,
  blue: number,
  duration: number,
  ...
  SetCineFilterStartColor(
    ...
    PercentTo255(green),
    PercentTo255(blue),
    PercentTo255(100 - startTrans),
  );
  SetCineFilterEndColor(
    PercentTo255(red),
    PercentTo255(green),
    PercentTo255(blue),
    PercentTo255(100 - endTrans),
  );
...
// ===========================================================================
export const ContinueCinematicFadeAfterBJ = (
  duration: number,
  red: number,
  green: number,
  blue: number,
...
export const AbortCinematicFadeBJ = (): void => {
  ...
  if (bj_cineFadeFinishTimer !== null) DestroyTimer(bj_cineFadeFinishTimer);
};

// ===========================================================================
export const CinematicFadeBJ = (
  fadetype: number,
  duration: number,
  tex: string,
  red: number,
...
// ===========================================================================
export const CinematicFilterGenericBJ = (
  duration: number,
  bmode: blendmode,
  tex: string,
  red0: number,
...
// ===========================================================================
export const MakeUnitRescuableToForceBJ = (
  whichUnit: unit,
  isRescuable: boolean,
  whichForce: force,
): void => {
...
// ===========================================================================
export const SetPlayerTechResearchedSwap = (
  techid: number,
  levels: number,
  whichPlayer: player,
): void => {
...
// ===========================================================================
export const SetPlayerTechMaxAllowedSwap = (
  techid: number,
  maximum: number,
  whichPlayer: player,
): void => {
...
// ===========================================================================
export const SetPlayerMaxHeroesAllowed = (
  maximum: number,
  whichPlayer: player,
): void => {
...
// ===========================================================================
export const GetPlayerTechCountSimple = (
  techid: number,
  whichPlayer: player,
): number => GetPlayerTechCount(whichPlayer, techid, true);

// ===========================================================================
export const GetPlayerTechMaxAllowedSwap = (
  techid: number,
  whichPlayer: player,
): number => GetPlayerTechMaxAllowed(whichPlayer, techid);

// ===========================================================================
export const SetPlayerAbilityAvailableBJ = (
  avail: boolean,
  abilid: number,
  whichPlayer: player,
): void => {
...
export const SetCampaignMenuRaceBJ = (campaignNumber: number): void => {
  if (campaignNumber === bj_CAMPAIGN_INDEX_T) SetCampaignMenuRace(RACE_OTHER);
...
//
export const SetMissionAvailableBJ = (
  available: boolean,
  missionIndex: number,
): void => {
...
// ===========================================================================
export const SetCampaignAvailableBJ = (
  available: boolean,
  campaignNumber: number,
): void => {
  let campaignOffset: number;

  if (campaignNumber === bj_CAMPAIGN_INDEX_H) SetTutorialCleared(true);
  ...
  } else campaignOffset = campaignNumber;
...
// ===========================================================================
export const SetCinematicAvailableBJ = (
  available: boolean,
...
// ===========================================================================
export const StoreStringBJ = (
  value: string,
  key: string,
  missionKey: string,
  cache: gamecache,
): boolean => StoreString(cache, missionKey, key, value);

// ===========================================================================
export const StoreUnitBJ = (
  whichUnit: unit,
  key: string,
  missionKey: string,
  cache: gamecache,
): boolean => StoreUnit(cache, missionKey, key, whichUnit);

// ===========================================================================
export const SaveRealBJ = (
  value: number,
  key: number,
  missionKey: number,
  table: hashtable,
...
// ===========================================================================
export const SaveStringBJ = (
  value: string,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveStr(table, missionKey, key, value);

// ===========================================================================
export const SavePlayerHandleBJ = (
  whichPlayer: player,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SavePlayerHandle(table, missionKey, key, whichPlayer);

// ===========================================================================
export const SaveWidgetHandleBJ = (
  whichWidget: widget,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveWidgetHandle(table, missionKey, key, whichWidget);

// ===========================================================================
export const SaveDestructableHandleBJ = (
  whichDestructable: destructable,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveDestructableHandle(table, missionKey, key, whichDestructable);

// ===========================================================================
export const SaveItemHandleBJ = (
  whichItem: item,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveItemHandle(table, missionKey, key, whichItem);

// ===========================================================================
export const SaveUnitHandleBJ = (
  whichUnit: unit,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveUnitHandle(table, missionKey, key, whichUnit);

// ===========================================================================
export const SaveAbilityHandleBJ = (
  whichAbility: ability,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveAbilityHandle(table, missionKey, key, whichAbility);

// ===========================================================================
export const SaveTimerHandleBJ = (
  whichTimer: timer,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveTimerHandle(table, missionKey, key, whichTimer);

// ===========================================================================
export const SaveTriggerHandleBJ = (
  whichTrigger: trigger,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveTriggerHandle(table, missionKey, key, whichTrigger);

// ===========================================================================
export const SaveTriggerConditionHandleBJ = (
  whichTriggercondition: triggercondition,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean =>
  SaveTriggerConditionHandle(table, missionKey, key, whichTriggercondition);

// ===========================================================================
export const SaveTriggerActionHandleBJ = (
  whichTriggeraction: triggeraction,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean =>
  SaveTriggerActionHandle(table, missionKey, key, whichTriggeraction);

// ===========================================================================
export const SaveTriggerEventHandleBJ = (
  whichEvent: event,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveTriggerEventHandle(table, missionKey, key, whichEvent);

// ===========================================================================
export const SaveForceHandleBJ = (
  whichForce: force,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveForceHandle(table, missionKey, key, whichForce);

// ===========================================================================
export const SaveGroupHandleBJ = (
  whichGroup: group,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveGroupHandle(table, missionKey, key, whichGroup);

// ===========================================================================
export const SaveLocationHandleBJ = (
  whichLocation: location,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveLocationHandle(table, missionKey, key, whichLocation);

// ===========================================================================
export const SaveRectHandleBJ = (
  whichRect: rect,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveRectHandle(table, missionKey, key, whichRect);

// ===========================================================================
export const SaveBooleanExprHandleBJ = (
  whichBoolexpr: boolexpr,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveBooleanExprHandle(table, missionKey, key, whichBoolexpr);

// ===========================================================================
export const SaveSoundHandleBJ = (
  whichSound: sound,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveSoundHandle(table, missionKey, key, whichSound);

// ===========================================================================
export const SaveEffectHandleBJ = (
  whichEffect: effect,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveEffectHandle(table, missionKey, key, whichEffect);

// ===========================================================================
export const SaveUnitPoolHandleBJ = (
  whichUnitpool: unitpool,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveUnitPoolHandle(table, missionKey, key, whichUnitpool);

// ===========================================================================
export const SaveItemPoolHandleBJ = (
  whichItempool: itempool,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveItemPoolHandle(table, missionKey, key, whichItempool);

// ===========================================================================
export const SaveQuestHandleBJ = (
  whichQuest: quest,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveQuestHandle(table, missionKey, key, whichQuest);

// ===========================================================================
export const SaveQuestItemHandleBJ = (
  whichQuestitem: questitem,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveQuestItemHandle(table, missionKey, key, whichQuestitem);

// ===========================================================================
export const SaveDefeatConditionHandleBJ = (
  whichDefeatcondition: defeatcondition,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean =>
  SaveDefeatConditionHandle(table, missionKey, key, whichDefeatcondition);

// ===========================================================================
export const SaveTimerDialogHandleBJ = (
  whichTimerdialog: timerdialog,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveTimerDialogHandle(table, missionKey, key, whichTimerdialog);

// ===========================================================================
export const SaveLeaderboardHandleBJ = (
  whichLeaderboard: leaderboard,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveLeaderboardHandle(table, missionKey, key, whichLeaderboard);

// ===========================================================================
export const SaveMultiboardHandleBJ = (
  whichMultiboard: multiboard,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveMultiboardHandle(table, missionKey, key, whichMultiboard);

// ===========================================================================
export const SaveMultiboardItemHandleBJ = (
  whichMultiboarditem: multiboarditem,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean =>
  SaveMultiboardItemHandle(table, missionKey, key, whichMultiboarditem);

// ===========================================================================
export const SaveTrackableHandleBJ = (
  whichTrackable: trackable,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveTrackableHandle(table, missionKey, key, whichTrackable);

// ===========================================================================
export const SaveDialogHandleBJ = (
  whichDialog: dialog,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveDialogHandle(table, missionKey, key, whichDialog);

// ===========================================================================
export const SaveButtonHandleBJ = (
  whichButton: button,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveButtonHandle(table, missionKey, key, whichButton);

// ===========================================================================
export const SaveTextTagHandleBJ = (
  whichTexttag: texttag,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveTextTagHandle(table, missionKey, key, whichTexttag);

// ===========================================================================
export const SaveLightningHandleBJ = (
  whichLightning: lightning,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveLightningHandle(table, missionKey, key, whichLightning);

// ===========================================================================
export const SaveImageHandleBJ = (
  whichImage: image,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveImageHandle(table, missionKey, key, whichImage);

// ===========================================================================
export const SaveUbersplatHandleBJ = (
  whichUbersplat: ubersplat,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveUbersplatHandle(table, missionKey, key, whichUbersplat);

// ===========================================================================
export const SaveRegionHandleBJ = (
  whichRegion: region,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveRegionHandle(table, missionKey, key, whichRegion);

// ===========================================================================
export const SaveFogStateHandleBJ = (
  whichFogState: fogstate,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveFogStateHandle(table, missionKey, key, whichFogState);

// ===========================================================================
export const SaveFogModifierHandleBJ = (
  whichFogModifier: fogmodifier,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveFogModifierHandle(table, missionKey, key, whichFogModifier);

// ===========================================================================
export const SaveAgentHandleBJ = (
  whichAgent: agent,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveAgentHandle(table, missionKey, key, whichAgent);

// ===========================================================================
export const SaveHashtableHandleBJ = (
  whichHashtable: hashtable,
  key: number,
  missionKey: number,
  table: hashtable,
): boolean => SaveHashtableHandle(table, missionKey, key, whichHashtable);

// ===========================================================================
export const GetStoredRealBJ = (
  key: string,
  missionKey: string,
  cache: gamecache,
): number =>
...
// ===========================================================================
export const GetStoredIntegerBJ = (
  key: string,
  missionKey: string,
  cache: gamecache,
): number =>
...
// ===========================================================================
export const GetStoredBooleanBJ = (
  key: string,
  missionKey: string,
  cache: gamecache,
): boolean =>
...
// ===========================================================================
export const GetStoredStringBJ = (
  key: string,
  missionKey: string,
  cache: gamecache,
): string => {
...
// ===========================================================================
export const LoadPlayerHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): player => LoadPlayerHandle(table, missionKey, key);

// ===========================================================================
export const LoadWidgetHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): widget => LoadWidgetHandle(table, missionKey, key);

// ===========================================================================
export const LoadDestructableHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): destructable => LoadDestructableHandle(table, missionKey, key);

// ===========================================================================
export const LoadItemHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): item => LoadItemHandle(table, missionKey, key);

// ===========================================================================
export const LoadUnitHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): unit => LoadUnitHandle(table, missionKey, key);

// ===========================================================================
export const LoadAbilityHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): ability => LoadAbilityHandle(table, missionKey, key);

// ===========================================================================
export const LoadTimerHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): timer => LoadTimerHandle(table, missionKey, key);

// ===========================================================================
export const LoadTriggerHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): trigger => LoadTriggerHandle(table, missionKey, key);

// ===========================================================================
export const LoadTriggerConditionHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): triggercondition => LoadTriggerConditionHandle(table, missionKey, key);

// ===========================================================================
export const LoadTriggerActionHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): triggeraction => LoadTriggerActionHandle(table, missionKey, key);

// ===========================================================================
export const LoadTriggerEventHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): event => LoadTriggerEventHandle(table, missionKey, key);

// ===========================================================================
export const LoadForceHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): force => LoadForceHandle(table, missionKey, key);

// ===========================================================================
export const LoadGroupHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): group => LoadGroupHandle(table, missionKey, key);

// ===========================================================================
export const LoadLocationHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): location => LoadLocationHandle(table, missionKey, key);

// ===========================================================================
export const LoadRectHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): rect => LoadRectHandle(table, missionKey, key);

// ===========================================================================
export const LoadBooleanExprHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): boolexpr => LoadBooleanExprHandle(table, missionKey, key);

// ===========================================================================
export const LoadSoundHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): sound => LoadSoundHandle(table, missionKey, key);

// ===========================================================================
export const LoadEffectHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): effect => LoadEffectHandle(table, missionKey, key);

// ===========================================================================
export const LoadUnitPoolHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): unitpool => LoadUnitPoolHandle(table, missionKey, key);

// ===========================================================================
export const LoadItemPoolHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): itempool => LoadItemPoolHandle(table, missionKey, key);

// ===========================================================================
export const LoadQuestHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): quest => LoadQuestHandle(table, missionKey, key);

// ===========================================================================
export const LoadQuestItemHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): questitem => LoadQuestItemHandle(table, missionKey, key);

// ===========================================================================
export const LoadDefeatConditionHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): defeatcondition => LoadDefeatConditionHandle(table, missionKey, key);

// ===========================================================================
export const LoadTimerDialogHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): timerdialog => LoadTimerDialogHandle(table, missionKey, key);

// ===========================================================================
export const LoadLeaderboardHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): leaderboard => LoadLeaderboardHandle(table, missionKey, key);

// ===========================================================================
export const LoadMultiboardHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): multiboard => LoadMultiboardHandle(table, missionKey, key);

// ===========================================================================
export const LoadMultiboardItemHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): multiboarditem => LoadMultiboardItemHandle(table, missionKey, key);

// ===========================================================================
export const LoadTrackableHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): trackable => LoadTrackableHandle(table, missionKey, key);

// ===========================================================================
export const LoadDialogHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): dialog => LoadDialogHandle(table, missionKey, key);

// ===========================================================================
export const LoadButtonHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): button => LoadButtonHandle(table, missionKey, key);

// ===========================================================================
export const LoadTextTagHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): texttag => LoadTextTagHandle(table, missionKey, key);

// ===========================================================================
export const LoadLightningHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): lightning => LoadLightningHandle(table, missionKey, key);

// ===========================================================================
export const LoadImageHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): image => LoadImageHandle(table, missionKey, key);

// ===========================================================================
export const LoadUbersplatHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): ubersplat => LoadUbersplatHandle(table, missionKey, key);

// ===========================================================================
export const LoadRegionHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): region => LoadRegionHandle(table, missionKey, key);

// ===========================================================================
export const LoadFogStateHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): fogstate => LoadFogStateHandle(table, missionKey, key);

// ===========================================================================
export const LoadFogModifierHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): fogmodifier => LoadFogModifierHandle(table, missionKey, key);

// ===========================================================================
export const LoadHashtableHandleBJ = (
  key: number,
  missionKey: number,
  table: hashtable,
): hashtable => LoadHashtableHandle(table, missionKey, key);

// ===========================================================================
export const RestoreUnitLocFacingAngleBJ = (
  key: string,
  missionKey: string,
  cache: gamecache,
...
// ===========================================================================
export const RestoreUnitLocFacingPointBJ = (
  key: string,
  missionKey: string,
  cache: gamecache,
  forWhichPlayer: player,
...
// ===========================================================================
export const FlushStoredMissionBJ = (
  missionKey: string,
  cache: gamecache,
): void => {
...
// ===========================================================================
export const FlushChildHashtableBJ = (
  missionKey: number,
  table: hashtable,
): void => {
...
// ===========================================================================
export const ShowCustomCampaignButton = (
  show: boolean,
  whichButton: number,
): void => {
...
export const IsCustomCampaignButtonVisibile = (whichButton: number): boolean =>
  GetCustomCampaignButtonVisible(whichButton - 1);

// ===========================================================================
export const LoadGameBJ = (
  loadFileName: string,
...
// ===========================================================================
export const SaveAndChangeLevelBJ = (
  saveFileName: string,
  newLevel: string,
  doScoreScreen: boolean,
): void => {
...
// ===========================================================================
export const SaveAndLoadGameBJ = (
  saveFileName: string,
  loadFileName: string,
  doScoreScreen: boolean,
): void => {
...
// ===========================================================================
export const RenameSaveDirectoryBJ = (
  sourceDirName: string,
  destDirName: string,
): boolean => RenameSaveDirectory(sourceDirName, destDirName);
...
// ===========================================================================
export const CopySaveGameBJ = (
  sourceSaveName: string,
  destSaveName: string,
): boolean => CopySaveGame(sourceSaveName, destSaveName);
...
export const GetPlayerStartLocationY = (whichPlayer: player): number =>
  GetStartLocationY(GetPlayerStartLocation(whichPlayer));

// ===========================================================================
export const GetPlayerStartLocationLoc = (whichPlayer: player): location =>
  GetStartLocationLoc(GetPlayerStartLocation(whichPlayer));
...
// ===========================================================================
export const IsPlayerSlotState = (
  whichPlayer: player,
  whichState: playerslotstate,
): boolean => GetPlayerSlotState(whichPlayer) === whichState;

// ===========================================================================
export const GetFadeFromSeconds = (seconds: number): number => {
  if (seconds !== 0) return 128 / R2I(seconds);
...
export const GetFadeFromSecondsAsReal = (seconds: number): number => {
  if (seconds !== 0) return 128 / seconds;

  return 10000;
};

// ===========================================================================
export const AdjustPlayerStateSimpleBJ = (
  whichPlayer: player,
...
// ===========================================================================
export const AdjustPlayerStateBJ = (
  delta: number,
  whichPlayer: player,
  whichPlayerState: playerstate,
): void => {
...
// ===========================================================================
export const SetPlayerTaxRateBJ = (
  rate: number,
...
// ===========================================================================
export const GetPlayerTaxRateBJ = (
  whichResource: playerstate,
  sourcePlayer: player,
  otherPlayer: player,
): number => GetPlayerTaxRate(sourcePlayer, otherPlayer, whichResource);

// ===========================================================================
export const IsPlayerFlagSetBJ = (
  whichPlayerFlag: playerstate,
  whichPlayer: player,
): boolean => GetPlayerState(whichPlayer, whichPlayerFlag) === 1;
...
export const BlightGoldMineForPlayerBJ = (
  ...
  const newMine = CreateBlightedGoldmine(
    whichPlayer,
    mineX,
    mineY,
    bj_UNIT_FACING,
...
// ===========================================================================
export const BlightGoldMineForPlayer = (
  goldMine: unit,
  whichPlayer: player,
): unit | null => {
...
export const IsPointBlightedBJ = (where: location): boolean =>
  IsPointBlighted(GetLocationX(where), GetLocationY(where));
...
// ===========================================================================
export const SetPlayerUnitAvailableBJ = (
  unitId: number,
  allowed: boolean,
  whichPlayer: player,
): void => {
  if (allowed) SetPlayerTechMaxAllowed(whichPlayer, unitId, -1);
  else SetPlayerTechMaxAllowed(whichPlayer, unitId, 0);
};
...
// ===========================================================================
export const IssueTargetOrderBJ = (
  whichUnit: unit,
  order: string,
  targetWidget: widget,
): boolean => IssueTargetOrder(whichUnit, order, targetWidget);

// ===========================================================================
export const IssuePointOrderLocBJ = (
  whichUnit: unit,
  order: string,
  whichLocation: location,
): boolean => IssuePointOrderLoc(whichUnit, order, whichLocation);

// ===========================================================================
// Two distinct trigger actions can't share the same function name, so this
// dummy function simply mimics the behavior of an existing call.
//
export const IssueTargetDestructableOrder = (
  whichUnit: unit,
  order: string,
  targetWidget: widget,
): boolean => IssueTargetOrder(whichUnit, order, targetWidget);

export const IssueTargetItemOrder = (
  whichUnit: unit,
  order: string,
  targetWidget: widget,
): boolean => IssueTargetOrder(whichUnit, order, targetWidget);
...
// ===========================================================================
export const IssueImmediateOrderBJ = (
  whichUnit: unit,
  order: string,
): boolean => IssueImmediateOrder(whichUnit, order);

// ===========================================================================
export const GroupTargetOrderBJ = (
  whichGroup: group,
  order: string,
  targetWidget: widget,
): boolean => GroupTargetOrder(whichGroup, order, targetWidget);

// ===========================================================================
export const GroupPointOrderLocBJ = (
  whichGroup: group,
  order: string,
  whichLocation: location,
): boolean => GroupPointOrderLoc(whichGroup, order, whichLocation);

// ===========================================================================
export const GroupImmediateOrderBJ = (
  whichGroup: group,
  order: string,
): boolean => GroupImmediateOrder(whichGroup, order);

// ===========================================================================
// Two distinct trigger actions can't share the same function name, so this
// dummy function simply mimics the behavior of an existing call.
//
export const GroupTargetDestructableOrder = (
  whichGroup: group,
  order: string,
  targetWidget: widget,
): boolean => GroupTargetOrder(whichGroup, order, targetWidget);

export const GroupTargetItemOrder = (
  whichGroup: group,
  order: string,
  targetWidget: widget,
): boolean => GroupTargetOrder(whichGroup, order, targetWidget);
...
// ===========================================================================
export const SetUnitRallyDestructable = (
  whichUnit: unit,
...
// ===========================================================================
export const SetBlightRadiusLocBJ = (
  addBlight: boolean,
  whichPlayer: player,
  loc: location,
  radius: number,
...
// ===========================================================================
export const ReducePlayerTechMaxAllowed = (
  whichPlayer: player,
  techId: number,
  limit: number,
): void => {
...
// ===========================================================================
export const MeleeClearNearbyUnits = (
  x: number,
  y: number,
  range: number,
): void => {
...
// ===========================================================================
export const MeleeFindNearestMine = (
  src: location,
  range: number,
): unit | null => {
...
// ===========================================================================
export const MeleeRandomHeroLoc = (
  p: player,
  id1: number,
  id2: number,
  id3: number,
  ...
  if (bj_meleeGrantHeroItems) MeleeGrantItemsToHero(hero);
...
//
export const MeleeGetProjectedLoc = (
  src: location,
  targ: location,
  distance: number,
  deltaAngle: number,
  ...
  const direction =
    Atan2(GetLocationY(targ) - srcY, GetLocationX(targ) - srcX) +
    deltaAngle;
  return Location(
    srcX + distance * Cos(direction),
    srcY + distance * Sin(direction),
  );
};

// ===========================================================================
export const MeleeGetNearestValueWithin = (
  val: number,
  minVal: number,
  maxVal: number,
): number => {
...
export const MeleeGetLocWithinRect = (src: location, r: rect): location => {
  const withinX = MeleeGetNearestValueWithin(
    GetLocationX(src),
    GetRectMinX(r),
    GetRectMaxX(r),
  );
  const withinY = MeleeGetNearestValueWithin(
    GetLocationY(src),
    GetRectMinY(r),
    GetRectMaxY(r),
  );
...
//
export const MeleeStartingUnitsHuman = (
  whichPlayer: player,
  startLoc: location,
  doHeroes: boolean,
  doCamera: boolean,
  ...
  if (doPreload) Preloader("scripts\\HumanMelee.pld");

  const nearestMine = MeleeFindNearestMine(
    startLoc,
  ...
  if (nearestMine !== null) {
    ...
    nearMineLoc = MeleeGetProjectedLoc(
      GetUnitLoc(nearestMine),
      startLoc,
      320,
      0,
    );
...
//
export const MeleeStartingUnitsOrc = (
  whichPlayer: player,
  startLoc: location,
  doHeroes: boolean,
  doCamera: boolean,
  ...
  if (doPreload) Preloader("scripts\\OrcMelee.pld");
...
//
export const MeleeStartingUnitsUndead = (
  whichPlayer: player,
  startLoc: location,
  doHeroes: boolean,
  doCamera: boolean,
  ...
  if (doPreload) Preloader("scripts\\UndeadMelee.pld");

  let nearestMine = MeleeFindNearestMine(
    startLoc,
    bj_MELEE_MINE_SEARCH_RADIUS,
  );
  ...
  if (nearestMine !== null) {
    ...
    nearTownLoc = MeleeGetProjectedLoc(
      startLoc,
      GetUnitLoc(nearestMine),
      288,
      0,
    ...
    bj_ghoul[GetPlayerId(whichPlayer)] = CreateUnit(
      whichPlayer,
      FourCC("ugho"),
      ghoulX + 0 * unitSpacing,
      ghoulY + 0 * unitSpacing,
      bj_UNIT_FACING,
    );
    ...
    CreateUnit(
      ...
      FourCC("uaco"),
      peonX + 0 * unitSpacing,
      peonY + 0.5 * unitSpacing,
      bj_UNIT_FACING,
    );
    CreateUnit(
      whichPlayer,
      FourCC("uaco"),
      peonX + 0.65 * unitSpacing,
      peonY - 0.5 * unitSpacing,
      bj_UNIT_FACING,
    );
    CreateUnit(
...
//
export const MeleeStartingUnitsNightElf = (
  whichPlayer: player,
  startLoc: location,
  doHeroes: boolean,
  doCamera: boolean,
  ...
  if (doPreload) Preloader("scripts\\NightElfMelee.pld");
  ...
  if (nearestMine !== null) {
    ...
    nearMineLoc = MeleeGetLocWithinRect(
      nearMineLoc,
      GetRectFromCircleBJ(GetUnitLoc(nearestMine), minTreeDist),
    );
    tree = CreateUnitAtLoc(
      whichPlayer,
      FourCC("etol"),
      nearMineLoc,
      bj_UNIT_FACING,
    ...
    wispLoc = MeleeGetProjectedLoc(
      GetUnitLoc(nearestMine),
      startLoc,
      320,
      0,
    );
    wispLoc = MeleeGetLocWithinRect(
      wispLoc,
      GetRectFromCircleBJ(GetUnitLoc(nearestMine), minWispDist),
    );
...
//
export const MeleeStartingUnitsUnknownRace = (
  whichPlayer: player,
  startLoc: location,
  doHeroes: boolean,
  doCamera: boolean,
...
export const MeleeStartingUnits = (): void => {
  ...
  while (true) {
    ...
    if (GetPlayerSlotState(indexPlayer) === PLAYER_SLOT_STATE_PLAYING) {
      indexStartLoc = GetStartLocationLoc(
        GetPlayerStartLocation(indexPlayer),
      );
...
// ===========================================================================
export const MeleeStartingUnitsForPlayer = (
  whichRace: race,
  whichPlayer: player,
  loc: location,
  doHeroes: boolean,
...
// ===========================================================================
export const MeleePlayerIsOpponent = (
  playerIndex: number,
  ...
  if (playerIndex === opponentIndex) return false;
  ...
  if (bj_meleeDefeated[opponentIndex]) return false;
  ...
  if (GetPlayerAlliance(thePlayer, theOpponent, ALLIANCE_PASSIVE)) {
    if (GetPlayerAlliance(theOpponent, thePlayer, ALLIANCE_PASSIVE)) {
      if (GetPlayerState(thePlayer, PLAYER_STATE_ALLIED_VICTORY) === 1) {
        if (
          GetPlayerState(theOpponent, PLAYER_STATE_ALLIED_VICTORY) ===
            1
        ) {
          return false;
        }
  ...
  while (true) {
    ...
    if (PlayersAreCoAllied(whichPlayer, indexPlayer)) {
      buildingCount = buildingCount +
        GetPlayerStructureCount(indexPlayer, true);
    }
  ...
  while (true) {
    ...
    if (PlayersAreCoAllied(whichPlayer, indexPlayer)) {
      keyStructs = keyStructs +
        GetPlayerTypedUnitCount(indexPlayer, "townhall", true, true);
      keyStructs = keyStructs +
        GetPlayerTypedUnitCount(indexPlayer, "greathall", true, true);
      keyStructs = keyStructs +
        GetPlayerTypedUnitCount(indexPlayer, "treeoflife", true, true);
      keyStructs = keyStructs +
        GetPlayerTypedUnitCount(indexPlayer, "necropolis", true, true);
    }
...
export const MeleeGetCrippledWarningMessage = (whichPlayer: player): string => {
  ...
  if (r === RACE_HUMAN) return GetLocalizedString("CRIPPLE_WARNING_HUMAN");
  else if (r === RACE_ORC) return GetLocalizedString("CRIPPLE_WARNING_ORC");
...
export const MeleeGetCrippledTimerMessage = (whichPlayer: player): string => {
  ...
  if (r === RACE_HUMAN) return GetLocalizedString("CRIPPLE_TIMER_HUMAN");
  else if (r === RACE_ORC) return GetLocalizedString("CRIPPLE_TIMER_ORC");
  else if (r === RACE_NIGHTELF) {
...
export const MeleeGetCrippledRevealedMessage = (whichPlayer: player): string =>
  GetLocalizedString("CRIPPLE_REVEALING_PREFIX") +
  GetPlayerName(whichPlayer) +
  GetLocalizedString("CRIPPLE_REVEALING_POSTFIX");

// ===========================================================================
export const MeleeExposePlayer = (
  whichPlayer: player,
  expose: boolean,
): void => {
  let playerIndex: number;
...
export const MeleeCrippledPlayerTimeout = (): void => {
  ...
  while (true) {
    if (bj_crippledTimer[playerIndex] === expiredTimer) break;

    playerIndex = playerIndex + 1;
    if (playerIndex === bj_MAX_PLAYERS) break;
  }

  if (playerIndex === bj_MAX_PLAYERS) return;
...
export const MeleeCheckForCrippledPlayers = (): void => {
  ...
  if (bj_finishSoonAllExposed) return;
...
export const MeleeTriggerActionPlayerDefeated = (): void => {
  ...
  if (MeleeGetAllyCount(thePlayer) > 0) {
    ...
    if (!bj_meleeDefeated[GetPlayerId(thePlayer)]) MeleeDoDefeat(thePlayer);
  } else {
    ...
    while (true) {
      ...
      if (bj_playerIsCrippled[playerIndex]) {
        ...
        if (GetLocalPlayer() === indexPlayer) {
          ...
          TimerDialogDisplay(
            bj_crippledTimerWindows[playerIndex],
            false,
          );
        }
      }
...
export const MeleeWasUserPlayer = (whichPlayer: player): boolean => {
  if (GetPlayerController(whichPlayer) !== MAP_CONTROL_USER) return false;

  const slotState = GetPlayerSlotState(whichPlayer);

  return (
    slotState === PLAYER_SLOT_STATE_PLAYING ||
    slotState === PLAYER_SLOT_STATE_LEFT
  );
};
...
export const MeleeTournamentFinishNowRuleA = (multiplier: number): void => {
  ...
  while (true) {
    ...
    if (MeleeWasUserPlayer(indexPlayer)) {
      ...
      if (playerScore[index] <= 0) playerScore[index] = 1;
    } else playerScore[index] = 0;
  ...
  if (teamCount !== 0) {
    ...
    while (true) {
      if (index !== bestTeam) {
        if (bestScore < multiplier * teamScore[index]) draw = true;
      }
...
export const MeleeTriggerTournamentFinishNow = (): void => {
  ...
  else MeleeTournamentFinishNowRuleA(3);
...
export const MeleeInitVictoryDefeat = (): void => {
  ...
  while (true) {
    ...
    if (GetPlayerSlotState(indexPlayer) === PLAYER_SLOT_STATE_PLAYING) {
      ...
      bj_crippledTimerWindows[index] = CreateTimerDialog(
        bj_crippledTimer[index],
      );
      TimerDialogSetTitle(
        bj_crippledTimerWindows[index],
...
// ===========================================================================
export const SetPlayerSlotAvailable = (
  whichPlayer: player,
  control: mapcontrol,
): void => {
...
export const InitGenericPlayerSlots = (): void => {
  ...
  if (gType === GAME_TYPE_MELEE) MeleeInitPlayerSlots();
  else if (gType === GAME_TYPE_FFA) FFAInitPlayerSlots();
  else if (gType === GAME_TYPE_USE_MAP_SETTINGS) {
    // Do nothing; the map-specific script handles this.
  } else if (gType === GAME_TYPE_ONE_ON_ONE) OneOnOneInitPlayerSlots();
  else if (gType === GAME_TYPE_TWO_TEAM_PLAY) TeamInitPlayerSlots(2);
  else if (gType === GAME_TYPE_THREE_TEAM_PLAY) TeamInitPlayerSlots(3);
  else if (gType === GAME_TYPE_FOUR_TEAM_PLAY) TeamInitPlayerSlots(4);
  else {
...
export const SetDNCSoundsDawn = (): void => {
  if (bj_useDawnDuskSounds) StartSound(bj_dawnSound);
};

// ===========================================================================
export const SetDNCSoundsDusk = (): void => {
  if (bj_useDawnDuskSounds) StartSound(bj_duskSound);
};
...
export const InitDNCSounds = (): void => {
  ...
  bj_dawnSound = CreateSoundFromLabel(
    "RoosterSound",
    false,
    false,
    false,
  ...
  bj_duskSound = CreateSoundFromLabel(
    "WolfSound",
    false,
    false,
    false,
...
export const InitBlizzardGlobals = (): void => {
  ...
  while (true) {
    ...
    if (
      GetPlayerController(Player(index)) === MAP_CONTROL_USER &&
  ...
  } else bj_MELEE_MAX_TWINKED_HEROES = bj_MELEE_MAX_TWINKED_HEROES_V1;
};
...
export const UpdateStockAvailability = (whichItem: item): void => {
  ...
  if (iType === ITEM_TYPE_PERMANENT) bj_stockAllowedPermanent[iLevel] = true;
  else if (iType === ITEM_TYPE_CHARGED) bj_stockAllowedCharged[iLevel] = true;
...
export const UpdateEachStockBuildingEnum = (): void => {
  ...
  while (true) {
    pickedItemId = ChooseRandomItemEx(
...
// ===========================================================================
export const UpdateEachStockBuilding = (
  iType: itemtype,
  iLevel: number,
): void => {
...
export const PerformStockUpdates = (): void => {
  ...
  if (allowedCombinations === 0) return;
...
export const RandomDistChoose = (): number => {
  ...
  if (bj_randDistCount === 0) return -1;
  ...
  while (true) {
    ...
    if (index === bj_randDistCount) done = true;
...
// Ability
// ===========================================================================
export const BlzSetAbilityBooleanFieldBJ = (
  whichAbility: ability,
  whichField: abilitybooleanfield,
  value: boolean,
): void => {
  bj_lastInstObjFuncSuccessful = BlzSetAbilityBooleanField(
    whichAbility,
    whichField,
    value,
  );
...
// ===========================================================================
export const BlzSetAbilityIntegerFieldBJ = (
  whichAbility: ability,
  whichField: abilityintegerfield,
  value: number,
): void => {
  bj_lastInstObjFuncSuccessful = BlzSetAbilityIntegerField(
    whichAbility,
    whichField,
    value,
  );
...
// ===========================================================================
export const BlzSetAbilityRealFieldBJ = (
  whichAbility: ability,
  whichField: abilityrealfield,
  value: number,
): void => {
  bj_lastInstObjFuncSuccessful = BlzSetAbilityRealField(
    whichAbility,
    whichField,
    value,
  );
...
// ===========================================================================
export const BlzSetAbilityStringFieldBJ = (
  whichAbility: ability,
  whichField: abilitystringfield,
  value: string,
): void => {
  bj_lastInstObjFuncSuccessful = BlzSetAbilityStringField(
    whichAbility,
    whichField,
    value,
  );
...
// ===========================================================================
export const BlzSetAbilityBooleanLevelFieldBJ = (
  whichAbility: ability,
  whichField: abilitybooleanlevelfield,
  level: number,
  value: boolean,
): void => {
  bj_lastInstObjFuncSuccessful = BlzSetAbilityBooleanLevelField(
    whichAbility,
    whichField,
    level,
    value,
...
// ===========================================================================
export const BlzSetAbilityIntegerLevelFieldBJ = (
  whichAbility: ability,
  whichField: abilityintegerlevelfield,
  level: number,
  value: number,
): void => {
  bj_lastInstObjFuncSuccessful = BlzSetAbilityIntegerLevelField(
    whichAbility,
    whichField,
    level,
    value,
...
// ===========================================================================
export const BlzSetAbilityRealLevelFieldBJ = (
  whichAbility: ability,
  whichField: abilityreallevelfield,
  level: number,
  value: number,
): void => {
  bj_lastInstObjFuncSuccessful = BlzSetAbilityRealLevelField(
    whichAbility,
    whichField,
    level,
    value,
...
// ===========================================================================
export const BlzSetAbilityStringLevelFieldBJ = (
  whichAbility: ability,
  whichField: abilitystringlevelfield,
  level: number,
  value: string,
): void => {
  bj_lastInstObjFuncSuccessful = BlzSetAbilityStringLevelField(
    whichAbility,
    whichField,
    level,
    value,
...
// ===========================================================================
export const BlzSetAbilityBooleanLevelArrayFieldBJ = (
  whichAbility: ability,
  ...
  bj_lastInstObjFuncSuccessful = BlzSetAbilityBooleanLevelArrayField(
    whichAbility,
    whichField,
    level,
    index,
...
// ===========================================================================
export const BlzSetAbilityIntegerLevelArrayFieldBJ = (
  whichAbility: ability,
  ...
  bj_lastInstObjFuncSuccessful = BlzSetAbilityIntegerLevelArrayField(
    whichAbility,
    whichField,
    level,
    index,
...
// ===========================================================================
export const BlzSetAbilityRealLevelArrayFieldBJ = (
  whichAbility: ability,
  ...
  bj_lastInstObjFuncSuccessful = BlzSetAbilityRealLevelArrayField(
    whichAbility,
    whichField,
    level,
    index,
...
// ===========================================================================
export const BlzSetAbilityStringLevelArrayFieldBJ = (
  whichAbility: ability,
  ...
  bj_lastInstObjFuncSuccessful = BlzSetAbilityStringLevelArrayField(
    whichAbility,
    whichField,
    level,
    index,
...
// ===========================================================================
export const BlzAddAbilityBooleanLevelArrayFieldBJ = (
  whichAbility: ability,
  whichField: abilitybooleanlevelarrayfield,
  level: number,
  value: boolean,
): void => {
  bj_lastInstObjFuncSuccessful = BlzAddAbilityBooleanLevelArrayField(
    whichAbility,
    whichField,
    level,
    value,
...
// ===========================================================================
export const BlzAddAbilityIntegerLevelArrayFieldBJ = (
  whichAbility: ability,
  whichField: abilityintegerlevelarrayfield,
  level: number,
  value: number,
): void => {
  bj_lastInstObjFuncSuccessful = BlzAddAbilityIntegerLevelArrayField(
    whichAbility,
    whichField,
    level,
    value,
...
// ===========================================================================
export const BlzAddAbilityRealLevelArrayFieldBJ = (
  whichAbility: ability,
  whichField: abilityreallevelarrayfield,
  level: number,
  value: number,
): void => {
  bj_lastInstObjFuncSuccessful = BlzAddAbilityRealLevelArrayField(
    whichAbility,
    whichField,
    level,
    value,
...
// ===========================================================================
export const BlzAddAbilityStringLevelArrayFieldBJ = (
  whichAbility: ability,
  whichField: abilitystringlevelarrayfield,
  level: number,
  value: string,
): void => {
  bj_lastInstObjFuncSuccessful = BlzAddAbilityStringLevelArrayField(
    whichAbility,
    whichField,
    level,
    value,
...
// ===========================================================================
export const BlzRemoveAbilityBooleanLevelArrayFieldBJ = (
  whichAbility: ability,
  whichField: abilitybooleanlevelarrayfield,
  level: number,
  value: boolean,
): void => {
  bj_lastInstObjFuncSuccessful = BlzRemoveAbilityBooleanLevelArrayField(
    whichAbility,
    whichField,
    level,
    value,
...
// ===========================================================================
export const BlzRemoveAbilityIntegerLevelArrayFieldBJ = (
  whichAbility: ability,
  whichField: abilityintegerlevelarrayfield,
  level: number,
  value: number,
): void => {
  bj_lastInstObjFuncSuccessful = BlzRemoveAbilityIntegerLevelArrayField(
    whichAbility,
    whichField,
    level,
    value,
...
// ===========================================================================
export const BlzRemoveAbilityRealLevelArrayFieldBJ = (
  whichAbility: ability,
  whichField: abilityreallevelarrayfield,
  level: number,
  value: number,
): void => {
  bj_lastInstObjFuncSuccessful = BlzRemoveAbilityRealLevelArrayField(
    whichAbility,
    whichField,
    level,
    value,
...
// ===========================================================================
export const BlzRemoveAbilityStringLevelArrayFieldBJ = (
  whichAbility: ability,
  whichField: abilitystringlevelarrayfield,
  level: number,
  value: string,
): void => {
  bj_lastInstObjFuncSuccessful = BlzRemoveAbilityStringLevelArrayField(
    whichAbility,
    whichField,
    level,
    value,
...
// Item
// =============================================================
export const BlzItemAddAbilityBJ = (
  whichItem: item,
  abilCode: number,
): void => {
...
// ===========================================================================
export const BlzItemRemoveAbilityBJ = (
  whichItem: item,
  abilCode: number,
): void => {
...
// ===========================================================================
export const BlzSetItemBooleanFieldBJ = (
  whichItem: item,
  whichField: itembooleanfield,
  value: boolean,
): void => {
  bj_lastInstObjFuncSuccessful = BlzSetItemBooleanField(
    whichItem,
    whichField,
    value,
  );
...
// ===========================================================================
export const BlzSetItemIntegerFieldBJ = (
  whichItem: item,
  whichField: itemintegerfield,
  value: number,
): void => {
  bj_lastInstObjFuncSuccessful = BlzSetItemIntegerField(
    whichItem,
    whichField,
    value,
  );
...
// ===========================================================================
export const BlzSetItemRealFieldBJ = (
  whichItem: item,
  whichField: itemrealfield,
  value: number,
): void => {
  bj_lastInstObjFuncSuccessful = BlzSetItemRealField(
    whichItem,
    whichField,
    value,
  );
...
// ===========================================================================
export const BlzSetItemStringFieldBJ = (
  whichItem: item,
  whichField: itemstringfield,
  value: string,
): void => {
  bj_lastInstObjFuncSuccessful = BlzSetItemStringField(
    whichItem,
    whichField,
    value,
  );
...
// Unit
// ===========================================================================
export const BlzSetUnitBooleanFieldBJ = (
  whichUnit: unit,
  whichField: unitbooleanfield,
  value: boolean,
): void => {
  bj_lastInstObjFuncSuccessful = BlzSetUnitBooleanField(
    whichUnit,
    whichField,
    value,
  );
...
// ===========================================================================
export const BlzSetUnitIntegerFieldBJ = (
  whichUnit: unit,
  whichField: unitintegerfield,
  value: number,
): void => {
  bj_lastInstObjFuncSuccessful = BlzSetUnitIntegerField(
    whichUnit,
    whichField,
    value,
  );
...
// ===========================================================================
export const BlzSetUnitRealFieldBJ = (
  whichUnit: unit,
  whichField: unitrealfield,
  value: number,
): void => {
  bj_lastInstObjFuncSuccessful = BlzSetUnitRealField(
    whichUnit,
    whichField,
    value,
  );
...
// ===========================================================================
export const BlzSetUnitStringFieldBJ = (
  whichUnit: unit,
  whichField: unitstringfield,
  value: string,
): void => {
  bj_lastInstObjFuncSuccessful = BlzSetUnitStringField(
    whichUnit,
    whichField,
    value,
  );
...
// Unit Weapon
// ===========================================================================
export const BlzSetUnitWeaponBooleanFieldBJ = (
  whichUnit: unit,
  whichField: unitweaponbooleanfield,
  index: number,
  value: boolean,
): void => {
  bj_lastInstObjFuncSuccessful = BlzSetUnitWeaponBooleanField(
    whichUnit,
    whichField,
    index,
    value,
...
// ===========================================================================
export const BlzSetUnitWeaponIntegerFieldBJ = (
  whichUnit: unit,
  whichField: unitweaponintegerfield,
  index: number,
  value: number,
): void => {
  bj_lastInstObjFuncSuccessful = BlzSetUnitWeaponIntegerField(
    whichUnit,
    whichField,
    index,
    value,
...
// ===========================================================================
export const BlzSetUnitWeaponRealFieldBJ = (
  whichUnit: unit,
  whichField: unitweaponrealfield,
  index: number,
  value: number,
): void => {
  bj_lastInstObjFuncSuccessful = BlzSetUnitWeaponRealField(
    whichUnit,
    whichField,
    index,
    value,
...
// ===========================================================================
export const BlzSetUnitWeaponStringFieldBJ = (
  whichUnit: unit,
  whichField: unitweaponstringfield,
  index: number,
  value: string,
): void => {
  bj_lastInstObjFuncSuccessful = BlzSetUnitWeaponStringField(
    whichUnit,
    whichField,
    index,
    value,
